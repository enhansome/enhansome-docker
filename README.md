...
If you would like to contribute, please read [CONTRIBUTING.md](https://github.com/veggiemonk/awesome-docker/blob/master/.github/CONTRIBUTING.md) ⭐ 36,754 | 🐛 27 | 📅 2026-08-27 first.
...
* [Moby](https://github.com/moby/moby) ⭐ 72,028 | 🐛 3,902 | 🌐 Go | 📅 2026-08-31
* [Docker Compose](https://github.com/docker/compose/) ⭐ 38,092 | 🐛 108 | 🌐 Go | 📅 2026-08-31 - Define and run multi-container applications with Docker.
* [Docker Hub](https://hub.docker.com)
* [Docker Registry][distribution] - The Docker toolset to pack, ship, store, and deliver content

## Engine & Runtime

* [podman](https://github.com/containers/libpod) ⭐ 32,741 | 🐛 1,148 | 🌐 Go | 📅 2026-08-31 - Libpod is a library used to create container pods. Home of Podman.
* [colima](https://github.com/abiosoft/colima) ⭐ 30,574 | 🐛 390 | 🌐 Go | 📅 2026-08-24 - Container runtimes on macOS (and Linux) with minimal setup.
* [containerd](https://github.com/containerd/containerd) ⭐ 21,231 | 🐛 443 | 🌐 Go | 📅 2026-08-31 - An open and reliable container runtime.
* [gVisor](https://github.com/google/gvisor) ⭐ 19,205 | 🐛 864 | 🌐 Go | 📅 2026-08-31 - Application Kernel for Containers.
* [runc](https://github.com/opencontainers/runc) ⭐ 13,425 | 🐛 350 | 🌐 Go | 📅 2026-08-31 - CLI tool for spawning and running containers according to the OCI specification.
* [youki](https://github.com/youki-dev/youki) ⭐ 7,573 | 🐛 148 | 🌐 Rust | 📅 2026-08-31 - Container runtime written in Rust, implementing the OCI runtime specification.
* [cri-o](https://github.com/cri-o/cri-o) ⭐ 5,654 | 🐛 144 | 🌐 Go | 📅 2026-08-31 - Open Container Initiative-based implementation of Kubernetes Container Runtime Interface.
* [lxc](https://github.com/lxc/lxc) ⭐ 5,251 | 🐛 149 | 🌐 C | 📅 2026-08-31 - LXC - Linux Containers.
* [runtime-tools](https://github.com/opencontainers/runtime-tools) ⭐ 493 | 🐛 72 | 🌐 Go | 📅 2026-03-16 - Oci-runtime-tool is a collection of tools for working with the OCI runtime specification.
* [Mocker](https://github.com/us/mocker) ⭐ 339 | 🐛 4 | 🌐 Swift | 📅 2026-08-25 - Docker-compatible container CLI for macOS, built on Apple's Containerization framework.
...
* [BuildKit](https://github.com/moby/buildkit) ⭐ 10,219 | 🐛 915 | 🌐 Go | 📅 2026-08-31 - Concurrent, cache-efficient, and Dockerfile-agnostic builder toolkit.
* [buildah](https://github.com/containers/buildah) ⭐ 9,000 | 🐛 288 | 🌐 Go | 📅 2026-08-31 - A tool that facilitates building OCI images.
* [ko](https://github.com/ko-build/ko) ⭐ 8,516 | 🐛 56 | 🌐 Go | 📅 2026-08-31 - Build and deploy Go applications as container images without a Dockerfile.
* [buildx](https://github.com/docker/buildx) ⭐ 4,491 | 🐛 391 | 🌐 Go | 📅 2026-08-28 - Official Docker CLI plugin for multi-platform builds backed by BuildKit.
...
* [runlike](https://github.com/lavie/runlike) ⭐ 2,940 | 🐛 8 | 🌐 Python | 📅 2026-04-27 - Generate `docker run`command and options from running containers.
* [apko](https://github.com/chainguard-dev/apko) ⭐ 1,669 | 🐛 157 | 🌐 Go | 📅 2026-08-31 - Declarative OCI image builder from apk packages; reproducible by design.
* [Whaler](https://github.com/P3GLEG/Whaler) ⭐ 1,191 | 🐛 8 | 🌐 Go | 📅 2026-04-08 - Program to reverse Docker images into Dockerfiles.
* [nix2container](https://github.com/nlewo/nix2container) ⭐ 902 | 🐛 86 | 🌐 Go | 📅 2026-04-06 - Build OCI images with Nix without `docker load` round-trips.
* [ansible-bender](https://github.com/ansible-community/ansible-bender) ⭐ 697 | 🐛 45 | 🌐 Python | 📅 2026-01-07 - A tool utilising `ansible` and `buildah`.
* [RAUDI](https://github.com/cybersecsi/RAUDI) ⭐ 560 | 🐛 1 | 🌐 Python | 📅 2026-08-31 - A tool to automatically update (and optionally push to Docker Hub) Docker Images for 3rd party software whenever theres is a new release/update/commit.
...
* [dlayer](https://github.com/orisano/dlayer) ⭐ 447 | 🐛 6 | 🌐 Go | 📅 2026-08-29 - Docker layer analyzer.
...
* [distroless](https://github.com/GoogleContainerTools/distroless) ⭐ 23,049 | 🐛 14 | 🌐 Starlark | 📅 2026-08-28 - Language focused docker images, minus the operating system.
* [Wolfi](https://github.com/wolfi-dev/os) ⭐ 1,282 | 🐛 83 | 🌐 Shell | 📅 2026-08-31 - Undistro Linux designed for containers; glibc-based, signed, daily SBOMs.
* [Chainguard Images](https://github.com/chainguard-images/images) ⭐ 692 | 🐛 114 | 🌐 HCL | 📅 2026-08-31 - Minimal, signed, SBOM-attested container images built on Wolfi.
* [melange](https://github.com/chainguard-dev/melange) ⭐ 623 | 🐛 262 | 🌐 Go | 📅 2026-08-31 - Build apk packages from declarative YAML for use with apko.
...
* [Dockershelf](https://github.com/Dockershelf/dockershelf) ⭐ 98 | 🐛 0 | 🌐 Shell | 📅 2026-08-31 - A repository that serves as a collector for docker recipes that are universal, efficient and slim. Images are updated, tested and published daily via a Travis cron job.
* [Dofigen](https://github.com/lenra-io/dofigen) ⭐ 73 | 🐛 27 | 🌐 Rust | 📅 2026-08-31 - A Dockerfile generator using a simplified description in YAML or JSON format.
...
* [Hadolint](https://github.com/hadolint/hadolint) ⭐ 12,378 | 🐛 203 | 🌐 Haskell | 📅 2026-08-24 - A Dockerfile linter that checks for best practices, common mistakes, and is also able to lint any bash written in `RUN` instructions;.
...
* [docker-image-size-limit](https://github.com/wemake-services/docker-image-size-limit) ⭐ 133 | 🐛 1 | 🌐 Python | 📅 2026-08-31 - A tool to keep an eye on your docker images size.
...
* [Harbor](https://github.com/goharbor/harbor) ⭐ 29,270 | 🐛 874 | 🌐 Go | 📅 2026-08-31 An open source trusted cloud native registry project that stores, signs, and scans content. Supports replication, user management, access control and activity auditing.
* [Kraken](https://github.com/uber/kraken) ⭐ 6,741 | 🐛 116 | 🌐 Go | 📅 2026-08-31 - Uber's Highly scalable P2P docker registry, capable of distributing TBs of data in seconds.
* [Dragonfly](https://github.com/dragonflyoss/Dragonfly2) ⭐ 3,313 | 🐛 38 | 🌐 Go | 📅 2026-08-31 - Provide efficient, stable and secure file distribution and image acceleration based on p2p technology.
* [NORA](https://github.com/getnora-io/nora) ⭐ 292 | 🐛 26 | 🌐 Rust | 📅 2026-08-30 - Lightweight multi-protocol artifact registry supporting Docker, Maven, npm, Cargo and PyPI in a single 32MB binary. Pull-through cache, Web UI, Prometheus metrics, RBAC auth.
...
* [skopeo](https://github.com/containers/skopeo) ⭐ 11,199 | 🐛 90 | 🌐 Go | 📅 2026-08-31 - Work with remote image registries: retrieve information, copy images, sign content.
* [crane](https://github.com/google/go-containerregistry/tree/main/cmd/crane) ⭐ 4,027 | 🐛 163 | 🌐 Go | 📅 2026-08-28 - Lightweight CLI to manipulate registry images, from `go-containerregistry`.
* [go-containerregistry](https://github.com/google/go-containerregistry) ⭐ 4,027 | 🐛 163 | 🌐 Go | 📅 2026-08-28 - Go library and CLI tools (`crane`, `gcrane`, `registry`) for working with container registries.
* [oras](https://github.com/oras-project/oras) ⭐ 2,408 | 🐛 73 | 🌐 Go | 📅 2026-08-31 - Push and pull arbitrary OCI artifacts to and from any OCI registry.
* [regctl](https://github.com/regclient/regclient) ⭐ 1,921 | 🐛 23 | 🌐 Go | 📅 2026-08-31 - Daemonless registry client; copy, inspect, modify, and sign OCI images.

### Image Scanning & SBOM

Image vulnerability scanners, SBOM generators, and digest pinning tools. Commercial entries marked `:yen:`.

* [Trivy](https://github.com/aquasecurity/trivy) ⭐ 37,716 | 🐛 264 | 🌐 Go | 📅 2026-08-28 - Aqua Security's open source simple and comprehensive vulnerability scanner for containers (suitable for CI).
* [Grype](https://github.com/anchore/grype) ⭐ 12,809 | 🐛 405 | 🌐 Go | 📅 2026-08-28 - A vulnerability scanner for container images, filesystems and SBOMs.
* [Clair](https://github.com/quay/clair) ⭐ 11,054 | 🐛 59 | 🌐 Go | 📅 2026-08-31 - Clair is an open source project for the static analysis of vulnerabilities in appc and docker containers.
* [Syft](https://github.com/anchore/syft) ⭐ 9,487 | 🐛 630 | 🌐 Go | 📅 2026-08-31 - CLI tool and library for generating a Software Bill of Materials (SBOM) from container images and filesystems.
* [oscap-docker](https://github.com/OpenSCAP/openscap) ⭐ 1,810 | 🐛 64 | 🌐 XSLT | 📅 2026-08-13 - OpenSCAP provides oscap-docker tool which is used to scan Docker containers and images.
* [Docker Scout](https://github.com/docker/scout-cli) ⭐ 453 | 🐛 70 | 🌐 Shell | 📅 2026-08-27 - Official Docker CLI for SBOM generation, vulnerability analysis, and policy evaluation.
...
* [BomLens](https://github.com/sktelecom/bomlens) ⭐ 17 | 🐛 3 | 🌐 Shell | 📅 2026-08-31 - Scan container images (plus source, binaries, and firmware) into CycloneDX SBOMs with vulnerability, license, and notice reports. Ships as a single Docker image with a web UI.
* [pindock](https://github.com/deadnews/pindock) ⭐ 3 | 🐛 1 | 🌐 Go | 📅 2026-08-22 - Pin and update Docker image digests in Dockerfiles and compose files.
...
* [cosign](https://github.com/sigstore/cosign) ⭐ 6,270 | 🐛 172 | 🌐 Go | 📅 2026-08-31 - Container signing, verification, and transparency log for OCI artifacts.
...
* [witness](https://github.com/in-toto/witness) ⭐ 546 | 🐛 77 | 🌐 Go | 📅 2026-08-31 - Generate and verify in-toto attestations across the build pipeline.
* [policy-controller](https://github.com/sigstore/policy-controller) ⭐ 178 | 🐛 91 | 🌐 Go | 📅 2026-08-24 - Kubernetes admission controller enforcing cosign signatures on container images.

## Running Containers

### Composition

* [kompose](https://github.com/kubernetes/kompose) ⭐ 10,619 | 🐛 21 | 🌐 Go | 📅 2026-08-31 - Go from Docker Compose to Kubernetes.
* [podman-compose](https://github.com/containers/podman-compose) ⭐ 6,208 | 🐛 336 | 🌐 Python | 📅 2026-08-11 - A script to run docker-compose.yml using podman.
* [Composerize](https://github.com/magicmark/composerize) ⭐ 3,756 | 🐛 11 | 🌐 JavaScript | 📅 2026-05-17 - Convert docker run commands into docker-compose files.
...
* [Kubernetes](https://github.com/kubernetes/kubernetes) ⭐ 125,609 | 🐛 3,009 | 🌐 Go | 📅 2026-08-31 - Open source orchestration system for Docker containers by Google.
* [Rancher](https://github.com/rancher/rancher) ⭐ 25,881 | 🐛 3,341 | 🌐 Go | 📅 2026-08-31 - An open source project that provides a complete platform for operating Docker in production.
* [Nomad](https://github.com/hashicorp/nomad) ⭐ 16,848 | 🐛 1,637 | 🌐 Go | 📅 2026-08-31 - Easily deploy applications at any scale. A Distributed, Highly Available, Datacenter-Aware Scheduler.
* [Mesos](https://github.com/apache/mesos) ⭐ 5,367 | 🐛 11 | 🌐 C++ | 📅 2026-05-15 - Resource/Job scheduler for containers, VM's and physical hosts.
* [docker rollout](https://github.com/Wowu/docker-rollout) ⭐ 3,319 | 🐛 8 | 🌐 Shell | 📅 2026-07-12 - Zero downtime deployment for Docker Compose services.
* [Swarm-cronjob](https://github.com/crazy-max/swarm-cronjob) ⭐ 882 | 🐛 37 | 🌐 Go | 📅 2026-08-20 - Create jobs on a time-based schedule on Swarm.
* [CloudSlang](https://github.com/CloudSlang/cloud-slang) ⭐ 242 | 🐛 111 | 🌐 Java | 📅 2026-08-25 - CloudSlang is a workflow engine to create Docker process automation.
...
* [Dokku](https://github.com/dokku/dokku) ⭐ 32,123 | 🐛 38 | 🌐 Shell | 📅 2026-08-31 - Docker powered mini-Heroku that helps you build and manage the lifecycle of applications.
* [caprover](https://github.com/caprover/caprover) ⭐ 15,150 | 🐛 176 | 🌐 TypeScript | 📅 2026-08-31 - \[Previously known as CaptainDuckDuck] Automated Scalable Webserver Package (automated Docker+nginx) - Heroku on Steroids.
* [Tsuru](https://github.com/tsuru/tsuru) ⭐ 5,308 | 🐛 18 | 🌐 Go | 📅 2026-08-31 - Tsuru is an extensible and open source Platform as a Service software.
* [werf](https://github.com/werf/werf) ⭐ 4,720 | 🐛 28 | 🌐 Go | 📅 2026-08-31 - Werf is a CI/CD tool for building Docker images efficiently and deploying them to Kubernetes using GitOps.
...
* [doco-cd](https://github.com/kimdre/doco-cd) ⭐ 1,644 | 🐛 11 | 🌐 Go | 📅 2026-08-31 - Lightweight GitOps and Continuous Deployment tool to deploy Docker Compose projects and Swarm stacks using polling and webhooks.
* [Grafeas](https://github.com/grafeas/grafeas) ⭐ 1,572 | 🐛 62 | 🌐 Go | 📅 2026-07-25 - A common API for metadata about containers, from image and build details to security vulnerabilities.
...
* [OpenRun](https://github.com/openrundev/openrun) ⭐ 963 | 🐛 1 | 🌐 Go | 📅 2026-08-31 - Builds, deploys, proxies, authenticates and auto-pauses web apps with Docker or Kubernetes.
...
* [docker-to-iac](https://github.com/deploystackio/docker-to-iac) ⭐ 22 | 🐛 14 | 🌐 TypeScript | 📅 2026-08-31 - Translate docker run and commit into Infrastructure as Code templates for AWS, Render.com and DigitalOcean.
...
* [Docuum](https://github.com/stepchowfun/docuum) ⭐ 709 | 🐛 13 | 🌐 Rust | 📅 2026-08-28 - Least recently used (LRU) eviction of Docker images.
...
* [netshoot](https://github.com/nicolaka/netshoot) ⭐ 10,969 | 🐛 43 | 🌐 Shell | 📅 2026-07-01 - The netshoot container has a powerful set of networking tools to help troubleshoot Docker networking issues.
* [Flannel](https://github.com/coreos/flannel/) ⭐ 9,529 | 🐛 24 | 🌐 Go | 📅 2026-08-31 - Flannel is a virtual network that gives a subnet to each host for use with container runtimes.
* [registrator](https://github.com/gliderlabs/registrator) ⭐ 4,674 | 🐛 257 | 🌐 Go | 📅 2025-05-22 - Service registry bridge for Docker.
* [Pipework](https://github.com/jpetazzo/pipework) ⭐ 4,254 | 🐛 5 | 🌐 Shell | 📅 2024-11-04 - Software-Defined Networking for Linux Containers, Pipework works with "plain" LXC containers, and with the awesome Docker.
...
* [Træfɪk](https://github.com/containous/traefik) ⭐ 64,682 | 🐛 908 | 🌐 Go | 📅 2026-08-31 - Automated reverse proxy and load-balancer for Docker, Mesos, Consul, Etcd.
* [Nginx Proxy Manager](https://github.com/jc21/nginx-proxy-manager) ⭐ 34,036 | 🐛 899 | 🌐 TypeScript | 📅 2026-08-31 - A beautiful web interface for proxying web based services with SSL.
* [BunkerWeb](https://github.com/bunkerity/bunkerweb) ⭐ 10,887 | 🐛 155 | 🌐 Python | 📅 2026-08-31 - Open-source and next-gen Web Application Firewall (WAF).
* [Let's Encrypt Nginx-proxy Companion](https://github.com/nginx-proxy/docker-letsencrypt-nginx-proxy-companion) ⭐ 7,724 | 🐛 39 | 🌐 Shell | 📅 2026-08-17 - A lightweight companion container for the nginx-proxy. It allow the creation/renewal of Let's Encrypt certificates automatically.
* [caddy-docker-proxy](https://github.com/lucaslorentz/caddy-docker-proxy) ⭐ 4,636 | 🐛 49 | 🌐 Go | 📅 2026-08-20 - Caddy-based reverse proxy, configured with service or container labels.
* [OpenResty Manager](https://github.com/Safe3/openresty-manager) ⭐ 1,444 | 🐛 59 | 🌐 Go | 📅 2026-08-19 - The easiest using, powerful and beautiful OpenResty Manager(Nginx Enhanced Version), open source alternative to OpenResty Edge.
...
* [Docker Volume Backup](https://github.com/offen/docker-volume-backup) ⭐ 3,994 | 🐛 27 | 🌐 Go | 📅 2026-08-25 Backup Docker volumes locally or to any S3 compatible storage.
* [REX-Ray](https://github.com/rexray/rexray) ⭐ 2,223 | 🐛 294 | 🌐 Go | 📅 2023-09-02 provides a vendor agnostic storage orchestration engine. The primary design goal is to provide persistent storage for Docker, Kubernetes, and Mesos.
...
* [cAdvisor](https://github.com/google/cadvisor) ⭐ 19,389 | 🐛 62 | 🌐 Go | 📅 2026-07-20 - Analyzes resource usage and performance characteristics of running containers.
* [dockprom](https://github.com/stefanprodan/dockprom) ⭐ 6,575 | 🐛 21 | 📅 2026-03-06 - Docker hosts and containers monitoring with Prometheus, Grafana, cAdvisor, NodeExporter and AlertManager.
* [Autoheal](https://github.com/willfarrell/docker-autoheal) ⭐ 1,990 | 🐛 62 | 🌐 Shell | 📅 2025-09-09 - Monitor and restart unhealthy docker containers automatically.
* [Maintenant](https://github.com/kolapsis/maintenant) ⭐ 462 | 🐛 4 | 🌐 Go | 📅 2026-08-31 - Self-discovering infrastructure monitoring for Docker and Kubernetes. Auto-detects containers via labels, with endpoint monitoring, heartbeats, TLS certificates, resource metrics, update intelligence, and a built-in status page. Single binary with embedded SPA.
* [Doku](https://github.com/amerkurev/doku) ⭐ 445 | 🐛 10 | 🌐 Python | 📅 2025-12-26 - Doku is a simple web-based application that allows you to monitor Docker disk usage.
* [Drydock](https://github.com/CodesWhat/drydock) ⭐ 248 | 🐛 8 | 🌐 TypeScript | 📅 2026-08-30 - Container update monitoring with web dashboard, 23 registry providers, 20 notification triggers, and distributed agent architecture.
* [InfraCanvas](https://github.com/bytestrix/InfraCanvas) ⭐ 78 | 🐛 7 | 🌐 Go | 📅 2026-08-25 - Live visual map of containers, pods, volumes, and networks on any Linux server. Single binary, WebSocket-powered live updates.
...
* [DockProbe](https://github.com/deep-on/dockprobe) ⭐ 20 | 🐛 1 | 🌐 Python | 📅 2026-08-29 - Lightweight Docker monitoring dashboard in a single container. Real-time metrics, 6 anomaly detection rules, Telegram alerts, and 16 automated security scans. Zero config, \~50MB RAM.
...
* [DLIA](https://github.com/zorak1103/dlia) ⭐ 7 | 🐛 2 | 🌐 Go | 📅 2026-08-31 - DLIA is an AI-powered Docker log monitoring agent that uses Large Language Models (LLMs) to intelligently analyze container logs, detect anomalies, and provide contextual insights over time.
...
* [docker-exporter](https://github.com/dlepaux/docker-exporter) ⭐ 3 | 🐛 18 | 🌐 Rust | 📅 2026-08-31 - Lightweight Prometheus exporter for Docker container metrics written in Rust. Correct cgroup v2 memory working set on ARM64 (Raspberry Pi 5), runs non-root with a read-only socket, \~7 MiB idle RAM.
...
* [docker-bench-security](https://github.com/docker/docker-bench-security) ⭐ 9,696 | 🐛 29 | 🌐 Shell | 📅 2026-06-04 - Script that checks for dozens of common best-practices around deploying Docker containers in production.
* [Sysdig Falco](https://github.com/falcosecurity/falco) ⭐ 9,319 | 🐛 64 | 🌐 C++ | 📅 2026-08-31 - Sysdig Falco is an open source container security monitor. It can monitor application, container, host, and network activity and alert on unauthorized activity.
* [Checkov](https://github.com/bridgecrewio/checkov) ⭐ 8,975 | 🐛 167 | 🌐 Python | 📅 2026-08-30 - Static analysis for infrastructure as code manifests (Terraform, Kubernetes, Cloudformation, Helm, Dockerfile, Kustomize) find security misconfiguration and fix them.
...
* [docker-socket-proxy](https://github.com/Tecnativa/docker-socket-proxy) ⭐ 2,739 | 🐛 51 | 🌐 Python | 📅 2026-08-31 - HAProxy-based fine-grained filter for the Docker API socket; widely used to expose a restricted socket to reverse proxies and homelab stacks.
* [KICS](https://github.com/checkmarx/kics) ⭐ 2,698 | 🐛 316 | 🌐 Open Policy Agent | 📅 2026-08-31 - An infrastructure-as-code scanning tool, find security vulnerabilities, compliance issues, and infrastructure misconfigurations early in the development cycle. Can be extended for additional policies.
* [container-explorer](https://github.com/google/container-explorer) ⭐ 106 | 🐛 2 | 🌐 Go | 📅 2026-08-28 - Forensic utility to explore Docker and containerd container details from mounted disk images.
* [CetusGuard](https://github.com/hectorm/cetusguard) ⭐ 90 | 🐛 3 | 🌐 Go | 📅 2026-04-01 - CetusGuard is a tool that protects the Docker daemon socket by filtering calls to its API endpoints.
* [compose-lint](https://github.com/tmatens/compose-lint) ⭐ 54 | 🐛 8 | 🌐 Python | 📅 2026-08-31 - Lints Docker Compose files for security misconfigurations — privileged containers, unpinned images, Docker socket mounts, plaintext credentials — grounded in OWASP and the CIS Docker Benchmark.
...
* [buildcage](https://github.com/dash14/buildcage) ⭐ 11 | 🐛 2 | 🌐 TypeScript | 📅 2026-08-31 - Restricts outbound network access during Docker builds to prevent supply chain attacks, working as a drop-in BuildKit remote driver for Docker Buildx, with ready-to-use GitHub Actions.
...
* [Simple Docker UI](https://github.com/felixgborrego/simple-docker-ui) ⭐ 605 | 🐛 20 | 🌐 Scala | 📅 2024-09-06 - Built on Electron.
* [Stevedore](https://github.com/slonopotamus/stevedore) ⭐ 383 | 🐛 2 | 🌐 Rust | 📅 2026-08-30 - Good Docker Desktop replacement for Windows. Both Linux and Windows Containers are supported. [slonopotamus](https://github.com/slonopotamus).
...
* [Gantry (Desktop)](https://github.com/getgantry/gantry) ⭐ 59 | 🐛 5 | 🌐 Swift | 📅 2026-08-31 - Native macOS app (SwiftUI, no Electron) for managing and monitoring Docker hosts, local and over SSH: fleet dashboard, live logs and stats, exec terminal, file browser, and a bundled MCP server for AI agents.
...
* [lazydocker](https://github.com/jesseduffield/lazydocker) ⭐ 52,685 | 🐛 297 | 🌐 Go | 📅 2026-04-19 - The lazier way to manage everything docker. A simple terminal UI for both docker and docker-compose, written in Go with the gocui library.
* [dockly](https://github.com/lirantal/dockly) ⭐ 4,032 | 🐛 5 | 🌐 JavaScript | 📅 2026-07-23 - An interactive shell UI for managing Docker containers.
* [dry](https://github.com/moncho/dry) ⭐ 3,274 | 🐛 27 | 🌐 Go | 📅 2026-08-21 - An interactive CLI for Docker containers.
* [DockSTARTer](https://github.com/GhostWriters/DockSTARTer) ⭐ 2,570 | 🐛 4 | 🌐 Shell | 📅 2026-08-31 - DockSTARTer helps you get started with home server apps running in Docker.
* [oxker](https://github.com/mrjackwills/oxker) ⭐ 1,824 | 🐛 23 | 🌐 Rust | 📅 2026-08-22 - A simple tui to view & control docker containers.
* [lazyjournal](https://github.com/Lifailon/lazyjournal) ⭐ 1,392 | 🐛 8 | 🌐 Go | 📅 2026-08-01 - A interface for reading and filtering the logs output of Docker and Podman containers like [Dozzle](dozzle) but for the terminal with support for fuzzy find, regex and output coloring.
...
* [dockerfilegraph](https://github.com/patrickhoefler/dockerfilegraph) ⭐ 274 | 🐛 2 | 🌐 Go | 📅 2026-08-29 - Visualize your multi-stage Dockerfiles.
...
* [d4s](https://github.com/jr-k/d4s) ⭐ 125 | 🐛 0 | 🌐 Go | 📅 2026-08-28 - A fast, keyboard-driven terminal UI to manage Docker containers, Compose stacks, and Swarm services with the ergonomics of K9s.
* [layerx](https://github.com/deveshctl/layerx) ⭐ 119 | 🐛 0 | 🌐 Go | 📅 2026-08-25 - Inspect container image layers in a TUI — browse filesystem diffs, view file contents inline, sort by size, extract individual files, and gate CI on efficiency thresholds. Supports Docker, Podman, and OCI archives.
...
* [supdock](https://github.com/segersniels/supdock) ⭐ 88 | 🐛 0 | 🌐 Go | 📅 2026-08-21 - Allows for slightly more visual usage of Docker with an interactive prompt.
...
* [Portainer](https://github.com/portainer/portainer) ⭐ 38,395 | 🐛 745 | 🌐 TypeScript | 📅 2026-08-28 - A lightweight management UI for managing your Docker hosts or Docker Swarm clusters.
* [dockge](https://github.com/louislam/dockge) ⭐ 24,225 | 🐛 168 | 🌐 TypeScript | 📅 2026-04-25 - Easy-to-use and reactive self-hosted docker compose.yaml stack-oriented manager.
* [Komodo](https://github.com/mbecker20/komodo) ⭐ 12,132 | 🐛 616 | 🌐 Rust | 📅 2026-08-27 - A tool to build and deploy software on many servers.
* [Arcane](https://github.com/getarcaneapp/arcane) ⭐ 7,202 | 🐛 130 | 🌐 Go | 📅 2026-08-31 - An easy and modern Docker management platform, built with everybody in mind.
* [Swarmpit](https://github.com/swarmpit/swarmpit) ⭐ 3,484 | 🐛 172 | 🌐 Clojure | 📅 2026-08-21 - Swarmpit provides simple and easy to use interface for your Docker Swarm cluster. You can manage your stacks, services, secrets, volumes, networks etc.
...
* [Docker Registry Browser](https://github.com/klausmeyer/docker-registry-browser) ⭐ 701 | 🐛 9 | 🌐 Ruby | 📅 2026-08-30 - Web Interface for the Docker Registry HTTP API v2.
* [Container Web TTY](https://github.com/wrfly/container-web-tty) ⭐ 259 | 🐛 12 | 🌐 Go | 📅 2026-08-19 - Connect your containers via a web-tty.
* [usulnet](https://github.com/fr4nsys/usulnet) ⭐ 127 | 🐛 2 | 🌐 Go | 📅 2026-05-21 - A complete and modern Docker management platform designed for sysadmin, devops with enterprise grade tools, cve scanner, ssh, rdp on web and much more.
* [DockScope](https://github.com/ManuelR-T/dockscope) ⭐ 107 | 🐛 14 | 🌐 TypeScript | 📅 2026-08-19 - Visualizes Docker containers in a 3D dependency graph with live metrics, logs, and an in-browser terminal.
* [CASA](https://github.com/knrdl/casa) ⭐ 87 | 🐛 1 | 🌐 Svelte | 📅 2026-08-24 - Outsource the administration of a handful of containers to your co-workers,.
* [Docker Commander](https://github.com/koduj-dev/docker-commander) ⭐ 3 | 🐛 1 | 🌐 Go | 📅 2026-08-31 - A self-hosted Docker management and monitoring UI with multi-host support, Compose management, aggregated logs, alerts, RBAC, vulnerability scanning, and MCP integration.

### IDE Integrations

* [docker.el](https://github.com/Silex/docker.el) ⭐ 826 | 🐛 7 | 🌐 Emacs Lisp | 📅 2026-08-24 Manage docker from Emacs.
...
* [dockerode](https://github.com/apocas/dockerode) ⭐ 4,943 | 🐛 25 | 🌐 JavaScript | 📅 2026-08-10 - Docker Remote API node.js module.
* [Docker.DotNet](https://github.com/Microsoft/Docker.DotNet) ⭐ 2,414 | 🐛 187 | 🌐 C# | 📅 2025-08-28 - C#/.NET HTTP client for the Docker remote API.
* [go-dockerclient](https://github.com/fsouza/go-dockerclient/) ⭐ 2,245 | 🐛 15 | 🌐 Go | 📅 2026-08-31 - Go HTTP client for the Docker remote API.
* [docker-maven-plugin](https://github.com/fabric8io/docker-maven-plugin) ⭐ 1,933 | 🐛 518 | 🌐 Java | 📅 2026-08-30 - A Maven plugin for running and creating Docker images.
* [sbt-docker](https://github.com/marcuslonnberg/sbt-docker) ⭐ 731 | 🐛 34 | 🌐 Scala | 📅 2024-12-12 - Create Docker images directly from sbt.
* [docker-controller-bot](https://github.com/dgongut/docker-controller-bot) ⭐ 257 | 🐛 14 | 🌐 Python | 📅 2026-08-28 - Telegram bot to control docker containers.
...
* [Docker Client for JVM](https://github.com/gesellix/docker-client) ⭐ 123 | 🐛 23 | 🌐 Groovy | 📅 2026-08-27 - A Docker remote api client library for the JVM, written in Groovy.
* [Gradle Docker plugin](https://github.com/gesellix/gradle-docker-plugin) ⭐ 82 | 🐛 11 | 🌐 Java | 📅 2026-08-27 - A Docker remote api plugin for Gradle.
...
* [Docker.Registry.DotNet](https://github.com/ChangemakerStudios/Docker.Registry.DotNet) ⭐ 43 | 🐛 3 | 🌐 C# | 📅 2026-08-15 - .NET (C#) Client Library for interacting with a Docker Registry API (v2).
...
* [Drone](https://github.com/drone/drone) ⭐ 38,187 | 🐛 103 | 🌐 Go | 📅 2026-08-31 - Continuous integration server built on Docker and configured using YAML files.
* [Diun](https://github.com/crazy-max/diun) ⭐ 4,895 | 🐛 104 | 🌐 Go | 📅 2026-08-11 - Receive notifications when an image or repository is updated on a Docker registry.
* [dockcheck](https://github.com/mag37/dockcheck) ⭐ 2,493 | 🐛 9 | 🌐 Shell | 📅 2026-08-11 - A script checking updates for docker images without pulling then auto-update selected/all containers. With notifications, pruning and more.
...
* [Docker plugin for Jenkins](https://github.com/jenkinsci/docker-plugin/) ⭐ 499 | 🐛 96 | 🌐 Java | 📅 2026-08-12 - The aim of the docker plugin is to be able to use a docker host to dynamically provision a slave, run a single build, then tear-down that slave.
* [Defang](https://github.com/DefangLabs/defang) ⭐ 165 | 🐛 214 | 🌐 Go | 📅 2026-08-28 - Deploy Docker Compose to your favorite cloud in minutes.
...
* [Self Hosted Runner](https://github.com/youssefbrr/self-hosted-runner) ⭐ 134 | 🐛 0 | 🌐 Dockerfile | 📅 2026-08-31 - Dockerized solution for setting up a self-hosted GitHub Actions runner with support for Linux, macOS, and Windows.
* [Gantry](https://github.com/shizunge/gantry) ⭐ 90 | 🐛 0 | 🌐 Shell | 📅 2026-08-25 - Automatically update selected Docker swarm services.
...
* [coder](https://github.com/coder/coder) ⭐ 14,313 | 🐛 954 | 🌐 Go | 📅 2026-08-31 - Remote development machines powered by Terraform or Docker.
* [Laradock](https://github.com/laradock/laradock) ⭐ 12,672 | 🐛 17 | 🌐 Dockerfile | 📅 2026-08-16 - Full PHP development environment based on Docker, running Nginx/Apache, PHP, MySQL, Redis and more as swappable Compose services.
...
* [DIP](https://github.com/bibendi/dip) ⭐ 1,348 | 🐛 15 | 🌐 Ruby | 📅 2026-05-23 - CLI utility for straightforward provisioning and interacting with an application configured by docker-compose.
...
* [dde](https://github.com/whatwedo/dde) ⭐ 48 | 🐛 11 | 🌐 PHP | 📅 2026-08-31 - Local development environment toolset based on Docker.
* [uniget](https://github.com/uniget-org/cli) ⭐ 24 | 🐛 17 | 🌐 Go | 📅 2026-08-21 - Uni(versal)get, the installer and updater for container tools and beyond (formerly docker-setup).
...
* [OpenFaaS](https://github.com/openfaas/faas) ⭐ 26,233 | 🐛 31 | 🌐 Go | 📅 2026-07-02 - A complete serverless functions framework for Docker and Kubernetes.
* [Apache OpenWhisk](https://github.com/apache/openwhisk) ⭐ 6,794 | 🐛 430 | 🌐 Scala | 📅 2026-08-24 - A serverless, open source cloud platform that executes functions in response to events at any scale.
...
* [dgoss](https://github.com/goss-org/goss/tree/master/extras/dgoss) ⭐ 5,957 | 🐛 64 | 🌐 Go | 📅 2026-08-29 - A fast YAML based tool for validating docker containers.
* [Pumba](https://github.com/alexei-led/pumba) ⭐ 3,141 | 🐛 3 | 🌐 Go | 📅 2026-08-31 - Chaos testing tool for Docker. Can be deployed on kubernetes and CoreOS cluster.
...
* [GoSu](https://github.com/tianon/gosu) ⭐ 5,004 | 🐛 8 | 🌐 Shell | 📅 2026-06-06 - Run this specific application as this specific user and get out of the pipeline (entrypoint script tool).
* [docker-gen](https://github.com/jwilder/docker-gen) ⭐ 4,631 | 🐛 28 | 🌐 Go | 📅 2026-08-30 - Generate files from docker container meta-data.
* [Ofelia](https://github.com/mcuadros/ofelia/) ⭐ 3,973 | 🐛 148 | 🌐 Go | 📅 2026-08-29 - Ofelia is a modern and low footprint job scheduler for docker environments, built on Go. Ofelia aims to be a replacement for the old fashioned cron. Supports configuration from container labels and/or configuration files.
* [supercronic](https://github.com/aptible/supercronic) ⭐ 2,622 | 🐛 55 | 🌐 Go | 📅 2026-08-14 - Crontab-compatible job runner, designed specifically to run in containers.
* [cdebug](https://github.com/iximiuz/cdebug) ⭐ 1,667 | 🐛 18 | 🌐 Go | 📅 2026-01-18 - Swiss-army knife for debugging running containers via ephemeral sidecars; works with Docker, containerd, and Kubernetes.
...
* [dockerize](https://github.com/powerman/dockerize) ⭐ 194 | 🐛 4 | 🌐 Go | 📅 2026-08-21 - Utility to simplify running applications in docker containers.
...
* [Docker Curriculum](https://github.com/prakhar1989/docker-curriculum) ⭐ 6,091 | 🐛 17 | 🌐 CSS | 📅 2026-08-12: A comprehensive tutorial for getting started with Docker. Teaches how to use Docker and deploy dockerized apps on AWS with Elastic Beanstalk and Elastic Container Service.
* [Dockerlings](https://github.com/furkan/dockerlings) ⭐ 1,029 | 🐛 0 | 🌐 Shell | 📅 2026-08-26: Learn docker from inside your terminal, with a modern TUI and bite sized exercises.
...
* [wsargent](https://github.com/wsargent/docker-cheat-sheet) ⭐ 22,547 | 🐛 7 | 📅 2024-12-31 (Most popular)
...
* [Cloud Native Landscape](https://github.com/cncf/landscape) ⭐ 9,984 | 🐛 95 | 📅 2026-08-31
...
* [Awesome Selfhosted](https://github.com/awesome-selfhosted/awesome-selfhosted) ⭐ 316,332 | 🐛 0 | 📅 2026-08-30 list of Free Software network services and web applications which can be hosted locally by running in a classical way (setup local web server and run applications from there) or in a Docker container.
* [Awesome Compose](https://github.com/docker/awesome-compose) ⭐ 46,208 | 🐛 417 | 🌐 HTML | 📅 2026-08-25 - Docker Compose samples.
* [Awesome Sysadmin](https://github.com/n1trux/awesome-sysadmin) ⭐ 35,029 | 🐛 0 | 📅 2026-08-29
* [ToolsOfTheTrade](https://github.com/cjbarber/ToolsOfTheTrade) ⭐ 17,162 | 🐛 17 | 📅 2026-05-16 a list of SaaS and On premise applications
* [Awesome Kubernetes](https://github.com/ramitsurana/awesome-kubernetes) ⭐ 16,062 | 🐛 83 | 🌐 Shell | 📅 2026-06-23
* [Awesome Linux Container](https://github.com/Friz-zy/awesome-linux-containers) ⭐ 2,094 | 🐛 11 | 📅 2024-04-09 more general about container than this repo.
...
* [How CVE's are handled on Offical Docker Images](https://github.com/docker-library/official-images/issues/1448) ⭐ 6,995 | 🐛 56 | 🌐 Shell | 📅 2026-08-28
