...
If you would like to contribute, please read [CONTRIBUTING.md](https://github.com/veggiemonk/awesome-docker/blob/master/.github/CONTRIBUTING.md) ⭐ 36,855 | 🐛 37 | 📅 2026-09-12 first.
...
* [Moby](https://github.com/moby/moby) ⭐ 72,112 | 🐛 3,904 | 🌐 Go | 📅 2026-09-20
* [Docker Compose](https://github.com/docker/compose/) ⭐ 38,199 | 🐛 107 | 🌐 Go | 📅 2026-09-18 - Define and run multi-container applications with Docker.
* [Docker Hub](https://hub.docker.com)
* [Docker Registry][distribution] - The Docker toolset to pack, ship, store, and deliver content

## Engine & Runtime

* [podman](https://github.com/containers/libpod) ⭐ 32,898 | 🐛 1,033 | 🌐 Go | 📅 2026-09-19 - Libpod is a library used to create container pods. Home of Podman.
* [colima](https://github.com/abiosoft/colima) ⭐ 30,888 | 🐛 395 | 🌐 Go | 📅 2026-09-19 - Container runtimes on macOS (and Linux) with minimal setup.
* [containerd](https://github.com/containerd/containerd) ⭐ 21,319 | 🐛 471 | 🌐 Go | 📅 2026-09-19 - An open and reliable container runtime.
* [gVisor](https://github.com/google/gvisor) ⭐ 19,369 | 🐛 813 | 🌐 Go | 📅 2026-09-19 - Application Kernel for Containers.
...
* [youki](https://github.com/youki-dev/youki) ⭐ 7,608 | 🐛 137 | 🌐 Rust | 📅 2026-09-19 - Container runtime written in Rust, implementing the OCI runtime specification.
* [cri-o](https://github.com/cri-o/cri-o) ⭐ 5,661 | 🐛 133 | 🌐 Go | 📅 2026-09-20 - Open Container Initiative-based implementation of Kubernetes Container Runtime Interface.
* [lxc](https://github.com/lxc/lxc) ⭐ 5,262 | 🐛 151 | 🌐 C | 📅 2026-09-07 - LXC - Linux Containers.
...
* [DockerSlim](https://github.com/docker-slim/docker-slim) ⭐ 23,413 | 🐛 211 | 🌐 Go | 📅 2026-09-19 shrinks fat Docker images creating the smallest possible images.
...
* [BuildKit](https://github.com/moby/buildkit) ⭐ 10,277 | 🐛 851 | 🌐 Go | 📅 2026-09-18 - Concurrent, cache-efficient, and Dockerfile-agnostic builder toolkit.
* [buildah](https://github.com/containers/buildah) ⭐ 9,027 | 🐛 281 | 🌐 Go | 📅 2026-09-18 - A tool that facilitates building OCI images.
* [ko](https://github.com/ko-build/ko) ⭐ 8,519 | 🐛 56 | 🌐 Go | 📅 2026-09-09 - Build and deploy Go applications as container images without a Dockerfile.
* [buildx](https://github.com/docker/buildx) ⭐ 4,506 | 🐛 294 | 🌐 Go | 📅 2026-09-18 - Official Docker CLI plugin for multi-platform builds backed by BuildKit.
...
* [runlike](https://github.com/lavie/runlike) ⭐ 2,945 | 🐛 8 | 🌐 Python | 📅 2026-04-27 - Generate `docker run`command and options from running containers.
* [apko](https://github.com/chainguard-dev/apko) ⭐ 1,677 | 🐛 77 | 🌐 Go | 📅 2026-09-19 - Declarative OCI image builder from apk packages; reproducible by design.
* [Whaler](https://github.com/P3GLEG/Whaler) ⭐ 1,191 | 🐛 8 | 🌐 Go | 📅 2026-04-08 - Program to reverse Docker images into Dockerfiles.
* [nix2container](https://github.com/nlewo/nix2container) ⭐ 912 | 🐛 98 | 🌐 Go | 📅 2026-09-07 - Build OCI images with Nix without `docker load` round-trips.
...
* [RAUDI](https://github.com/cybersecsi/RAUDI) ⭐ 560 | 🐛 1 | 🌐 Python | 📅 2026-09-20 - A tool to automatically update (and optionally push to Docker Hub) Docker Images for 3rd party software whenever theres is a new release/update/commit.
...
* [distroless](https://github.com/GoogleContainerTools/distroless) ⭐ 23,085 | 🐛 14 | 🌐 Starlark | 📅 2026-09-19 - Language focused docker images, minus the operating system.
* [Wolfi](https://github.com/wolfi-dev/os) ⭐ 1,288 | 🐛 88 | 🌐 Shell | 📅 2026-09-19 - Undistro Linux designed for containers; glibc-based, signed, daily SBOMs.
* [Chainguard Images](https://github.com/chainguard-images/images) ⭐ 693 | 🐛 115 | 🌐 HCL | 📅 2026-09-20 - Minimal, signed, SBOM-attested container images built on Wolfi.
* [melange](https://github.com/chainguard-dev/melange) ⭐ 628 | 🐛 260 | 🌐 Go | 📅 2026-09-18 - Build apk packages from declarative YAML for use with apko.
...
* [Dockershelf](https://github.com/Dockershelf/dockershelf) ⭐ 98 | 🐛 0 | 🌐 Shell | 📅 2026-09-20 - A repository that serves as a collector for docker recipes that are universal, efficient and slim. Images are updated, tested and published daily via a Travis cron job.
...
* [Hadolint](https://github.com/hadolint/hadolint) ⭐ 12,419 | 🐛 207 | 🌐 Haskell | 📅 2026-08-24 - A Dockerfile linter that checks for best practices, common mistakes, and is also able to lint any bash written in `RUN` instructions;.
...
* [Harbor](https://github.com/goharbor/harbor) ⭐ 29,419 | 🐛 902 | 🌐 Go | 📅 2026-09-18 An open source trusted cloud native registry project that stores, signs, and scans content. Supports replication, user management, access control and activity auditing.
* [Kraken](https://github.com/uber/kraken) ⭐ 6,748 | 🐛 117 | 🌐 Go | 📅 2026-09-18 - Uber's Highly scalable P2P docker registry, capable of distributing TBs of data in seconds.
* [Dragonfly](https://github.com/dragonflyoss/Dragonfly2) ⭐ 3,334 | 🐛 25 | 🌐 Go | 📅 2026-09-17 - Provide efficient, stable and secure file distribution and image acceleration based on p2p technology.
* [NORA](https://github.com/getnora-io/nora) ⭐ 301 | 🐛 25 | 🌐 Rust | 📅 2026-09-20 - Lightweight multi-protocol artifact registry supporting Docker, Maven, npm, Cargo and PyPI in a single 32MB binary. Pull-through cache, Web UI, Prometheus metrics, RBAC auth.
...
* [skopeo](https://github.com/containers/skopeo) ⭐ 11,237 | 🐛 81 | 🌐 Go | 📅 2026-09-20 - Work with remote image registries: retrieve information, copy images, sign content.
* [crane](https://github.com/google/go-containerregistry/tree/main/cmd/crane) ⭐ 4,054 | 🐛 155 | 🌐 Go | 📅 2026-09-16 - Lightweight CLI to manipulate registry images, from `go-containerregistry`.
* [go-containerregistry](https://github.com/google/go-containerregistry) ⭐ 4,054 | 🐛 155 | 🌐 Go | 📅 2026-09-16 - Go library and CLI tools (`crane`, `gcrane`, `registry`) for working with container registries.
* [oras](https://github.com/oras-project/oras) ⭐ 2,435 | 🐛 80 | 🌐 Go | 📅 2026-09-18 - Push and pull arbitrary OCI artifacts to and from any OCI registry.
...
* [Trivy](https://github.com/aquasecurity/trivy) ⭐ 37,990 | 🐛 270 | 🌐 Go | 📅 2026-09-18 - Aqua Security's open source simple and comprehensive vulnerability scanner for containers (suitable for CI).
* [Grype](https://github.com/anchore/grype) ⭐ 12,909 | 🐛 401 | 🌐 Go | 📅 2026-09-18 - A vulnerability scanner for container images, filesystems and SBOMs.
* [Clair](https://github.com/quay/clair) ⭐ 11,063 | 🐛 54 | 🌐 Go | 📅 2026-09-18 - Clair is an open source project for the static analysis of vulnerabilities in appc and docker containers.
* [Syft](https://github.com/anchore/syft) ⭐ 9,589 | 🐛 648 | 🌐 Go | 📅 2026-09-18 - CLI tool and library for generating a Software Bill of Materials (SBOM) from container images and filesystems.
* [oscap-docker](https://github.com/OpenSCAP/openscap) ⭐ 1,817 | 🐛 60 | 🌐 XSLT | 📅 2026-09-11 - OpenSCAP provides oscap-docker tool which is used to scan Docker containers and images.
...
* [BomLens](https://github.com/sktelecom/bomlens) ⭐ 21 | 🐛 3 | 🌐 Shell | 📅 2026-09-17 - Scan container images (plus source, binaries, and firmware) into CycloneDX SBOMs with vulnerability, license, and notice reports. Ships as a single Docker image with a web UI.
...
* [cosign](https://github.com/sigstore/cosign) ⭐ 6,315 | 🐛 158 | 🌐 Go | 📅 2026-09-18 - Container signing, verification, and transparency log for OCI artifacts.
* [in-toto](https://github.com/in-toto/in-toto) ⭐ 1,041 | 🐛 61 | 🌐 Python | 📅 2026-08-27 - Framework for supply chain attestations; underpins SLSA and cosign provenance.
...
* [policy-controller](https://github.com/sigstore/policy-controller) ⭐ 181 | 🐛 95 | 🌐 Go | 📅 2026-09-17 - Kubernetes admission controller enforcing cosign signatures on container images.

## Running Containers

### Composition

* [kompose](https://github.com/kubernetes/kompose) ⭐ 10,625 | 🐛 18 | 🌐 Go | 📅 2026-09-18 - Go from Docker Compose to Kubernetes.
...
* [Composerize](https://github.com/magicmark/composerize) ⭐ 3,762 | 🐛 11 | 🌐 JavaScript | 📅 2026-05-17 - Convert docker run commands into docker-compose files.
...
* [Kubernetes](https://github.com/kubernetes/kubernetes) ⭐ 127,850 | 🐛 3,076 | 🌐 Go | 📅 2026-09-20 - Open source orchestration system for Docker containers by Google.
* [Rancher](https://github.com/rancher/rancher) ⭐ 25,924 | 🐛 3,366 | 🌐 Go | 📅 2026-09-19 - An open source project that provides a complete platform for operating Docker in production.
* [Nomad](https://github.com/hashicorp/nomad) ⭐ 16,955 | 🐛 1,627 | 🌐 Go | 📅 2026-09-18 - Easily deploy applications at any scale. A Distributed, Highly Available, Datacenter-Aware Scheduler.
...
* [Swarm-cronjob](https://github.com/crazy-max/swarm-cronjob) ⭐ 884 | 🐛 40 | 🌐 Go | 📅 2026-09-17 - Create jobs on a time-based schedule on Swarm.
...
* [Dokku](https://github.com/dokku/dokku) ⭐ 32,148 | 🐛 29 | 🌐 Go | 📅 2026-09-20 - Docker powered mini-Heroku that helps you build and manage the lifecycle of applications.
* [caprover](https://github.com/caprover/caprover) ⭐ 15,167 | 🐛 175 | 🌐 TypeScript | 📅 2026-09-19 - \[Previously known as CaptainDuckDuck] Automated Scalable Webserver Package (automated Docker+nginx) - Heroku on Steroids.
* [Tsuru](https://github.com/tsuru/tsuru) ⭐ 5,311 | 🐛 20 | 🌐 Go | 📅 2026-09-17 - Tsuru is an extensible and open source Platform as a Service software.
* [werf](https://github.com/werf/werf) ⭐ 4,723 | 🐛 32 | 🌐 Go | 📅 2026-09-18 - Werf is a CI/CD tool for building Docker images efficiently and deploying them to Kubernetes using GitOps.
...
* [OpenRun](https://github.com/openrundev/openrun) ⭐ 975 | 🐛 1 | 🌐 Go | 📅 2026-09-17 - Builds, deploys, proxies, authenticates and auto-pauses web apps with Docker or Kubernetes.
...
* [Docuum](https://github.com/stepchowfun/docuum) ⭐ 709 | 🐛 12 | 🌐 Rust | 📅 2026-09-19 - Least recently used (LRU) eviction of Docker images.
...
* [netshoot](https://github.com/nicolaka/netshoot) ⭐ 11,003 | 🐛 43 | 🌐 Shell | 📅 2026-07-01 - The netshoot container has a powerful set of networking tools to help troubleshoot Docker networking issues.
* [Flannel](https://github.com/coreos/flannel/) ⭐ 9,542 | 🐛 18 | 🌐 Go | 📅 2026-09-18 - Flannel is a virtual network that gives a subnet to each host for use with container runtimes.
...
* [Træfɪk](https://github.com/containous/traefik) ⭐ 64,907 | 🐛 943 | 🌐 Go | 📅 2026-09-18 - Automated reverse proxy and load-balancer for Docker, Mesos, Consul, Etcd.
* [Nginx Proxy Manager](https://github.com/jc21/nginx-proxy-manager) ⭐ 34,182 | 🐛 879 | 🌐 TypeScript | 📅 2026-09-14 - A beautiful web interface for proxying web based services with SSL.
* [BunkerWeb](https://github.com/bunkerity/bunkerweb) ⭐ 10,983 | 🐛 169 | 🌐 Python | 📅 2026-09-19 - Open-source and next-gen Web Application Firewall (WAF).
* [Let's Encrypt Nginx-proxy Companion](https://github.com/nginx-proxy/docker-letsencrypt-nginx-proxy-companion) ⭐ 7,729 | 🐛 40 | 🌐 Shell | 📅 2026-08-17 - A lightweight companion container for the nginx-proxy. It allow the creation/renewal of Let's Encrypt certificates automatically.
* [caddy-docker-proxy](https://github.com/lucaslorentz/caddy-docker-proxy) ⭐ 4,652 | 🐛 49 | 🌐 Go | 📅 2026-09-19 - Caddy-based reverse proxy, configured with service or container labels.
* [OpenResty Manager](https://github.com/Safe3/openresty-manager) ⭐ 1,456 | 🐛 59 | 🌐 Go | 📅 2026-08-19 - The easiest using, powerful and beautiful OpenResty Manager(Nginx Enhanced Version), open source alternative to OpenResty Edge.
...
* [Docker Volume Backup](https://github.com/offen/docker-volume-backup) ⭐ 4,013 | 🐛 25 | 🌐 Go | 📅 2026-09-18 Backup Docker volumes locally or to any S3 compatible storage.
...
* [Autoheal](https://github.com/willfarrell/docker-autoheal) ⭐ 2,003 | 🐛 62 | 🌐 Shell | 📅 2025-09-09 - Monitor and restart unhealthy docker containers automatically.
* [Maintenant](https://github.com/kolapsis/maintenant) ⭐ 508 | 🐛 2 | 🌐 Go | 📅 2026-09-18 - Self-discovering infrastructure monitoring for Docker and Kubernetes. Auto-detects containers via labels, with endpoint monitoring, heartbeats, TLS certificates, resource metrics, update intelligence, and a built-in status page. Single binary with embedded SPA.
...
* [Drydock](https://github.com/CodesWhat/drydock) ⭐ 253 | 🐛 33 | 🌐 TypeScript | 📅 2026-09-19 - Container update monitoring with web dashboard, 23 registry providers, 20 notification triggers, and distributed agent architecture.
* [InfraCanvas](https://github.com/bytestrix/InfraCanvas) ⭐ 81 | 🐛 10 | 🌐 Go | 📅 2026-09-17 - Live visual map of containers, pods, volumes, and networks on any Linux server. Single binary, WebSocket-powered live updates.
...
* [DockProbe](https://github.com/deep-on/dockprobe) ⭐ 21 | 🐛 2 | 🌐 Python | 📅 2026-09-17 - Lightweight Docker monitoring dashboard in a single container. Real-time metrics, 6 anomaly detection rules, Telegram alerts, and 16 automated security scans. Zero config, \~50MB RAM.
...
* [DLIA](https://github.com/zorak1103/dlia) ⭐ 7 | 🐛 6 | 🌐 Go | 📅 2026-09-20 - DLIA is an AI-powered Docker log monitoring agent that uses Large Language Models (LLMs) to intelligently analyze container logs, detect anomalies, and provide contextual insights over time.
...
* [docker-exporter](https://github.com/dlepaux/docker-exporter) ⭐ 4 | 🐛 2 | 🌐 Rust | 📅 2026-09-15 - Lightweight Prometheus exporter for Docker container metrics written in Rust. Correct cgroup v2 memory working set on ARM64 (Raspberry Pi 5), runs non-root with a read-only socket, \~7 MiB idle RAM.
...
* [docker-bench-security](https://github.com/docker/docker-bench-security) ⭐ 9,699 | 🐛 28 | 🌐 Shell | 📅 2026-06-04 - Script that checks for dozens of common best-practices around deploying Docker containers in production.
* [Sysdig Falco](https://github.com/falcosecurity/falco) ⭐ 9,396 | 🐛 42 | 🌐 C++ | 📅 2026-09-18 - Sysdig Falco is an open source container security monitor. It can monitor application, container, host, and network activity and alert on unauthorized activity.
* [Checkov](https://github.com/bridgecrewio/checkov) ⭐ 9,016 | 🐛 171 | 🌐 Python | 📅 2026-09-17 - Static analysis for infrastructure as code manifests (Terraform, Kubernetes, Cloudformation, Helm, Dockerfile, Kustomize) find security misconfiguration and fix them.
* [Deepfence Threat Mapper](https://github.com/deepfence/ThreatMapper) ⭐ 5,323 | 🐛 144 | 🌐 TypeScript | 📅 2026-06-01 - Powerful runtime vulnerability scanner for kubernetes, virtual machines and serverless.
* [docker-socket-proxy](https://github.com/Tecnativa/docker-socket-proxy) ⭐ 2,781 | 🐛 52 | 🌐 Python | 📅 2026-08-31 - HAProxy-based fine-grained filter for the Docker API socket; widely used to expose a restricted socket to reverse proxies and homelab stacks.
* [KICS](https://github.com/checkmarx/kics) ⭐ 2,704 | 🐛 312 | 🌐 Open Policy Agent | 📅 2026-09-17 - An infrastructure-as-code scanning tool, find security vulnerabilities, compliance issues, and infrastructure misconfigurations early in the development cycle. Can be extended for additional policies.
...
* [compose-lint](https://github.com/tmatens/compose-lint) ⭐ 58 | 🐛 4 | 🌐 Python | 📅 2026-09-20 - Lints Docker Compose files for security misconfigurations — privileged containers, unpinned images, Docker socket mounts, plaintext credentials — grounded in OWASP and the CIS Docker Benchmark.
...
* [buildcage](https://github.com/dash14/buildcage) ⭐ 11 | 🐛 3 | 🌐 TypeScript | 📅 2026-09-20 - Restricts outbound network access during Docker builds to prevent supply chain attacks, working as a drop-in BuildKit remote driver for Docker Buildx, with ready-to-use GitHub Actions.
...
* [lazydocker](https://github.com/jesseduffield/lazydocker) ⭐ 52,874 | 🐛 300 | 🌐 Go | 📅 2026-04-19 - The lazier way to manage everything docker. A simple terminal UI for both docker and docker-compose, written in Go with the gocui library.
...
* [dry](https://github.com/moncho/dry) ⭐ 3,278 | 🐛 27 | 🌐 Go | 📅 2026-09-04 - An interactive CLI for Docker containers.
* [DockSTARTer](https://github.com/GhostWriters/DockSTARTer) ⭐ 2,570 | 🐛 4 | 🌐 Shell | 📅 2026-09-20 - DockSTARTer helps you get started with home server apps running in Docker.
* [oxker](https://github.com/mrjackwills/oxker) ⭐ 1,848 | 🐛 23 | 🌐 Rust | 📅 2026-08-22 - A simple tui to view & control docker containers.
* [lazyjournal](https://github.com/Lifailon/lazyjournal) ⭐ 1,407 | 🐛 9 | 🌐 Go | 📅 2026-08-01 - A interface for reading and filtering the logs output of Docker and Podman containers like [Dozzle](dozzle) but for the terminal with support for fuzzy find, regex and output coloring.
...
* [dockerfilegraph](https://github.com/patrickhoefler/dockerfilegraph) ⭐ 275 | 🐛 2 | 🌐 Go | 📅 2026-09-18 - Visualize your multi-stage Dockerfiles.
...
* [d4s](https://github.com/jr-k/d4s) ⭐ 130 | 🐛 0 | 🌐 Go | 📅 2026-09-12 - A fast, keyboard-driven terminal UI to manage Docker containers, Compose stacks, and Swarm services with the ergonomics of K9s.
...
* [supdock](https://github.com/segersniels/supdock) ⭐ 88 | 🐛 2 | 🌐 Go | 📅 2026-09-17 - Allows for slightly more visual usage of Docker with an interactive prompt.
...
* [DockTUI](https://github.com/strmax195-hue/docktui) ⭐ 36 | 🐛 3 | 🌐 Python | 📅 2026-07-27 - Fast, zero-dependency terminal dashboard for Docker and Compose.
...
* [docker-captain](https://github.com/lucabello/docker-captain) ⭐ 3 | 🐛 3 | 🌐 Python | 📅 2026-09-18 - A friendly CLI to manage multiple Docker Compose deployments with style — powered by Typer, Rich, questionary, and sh.

### Web

* [Portainer](https://github.com/portainer/portainer) ⭐ 38,526 | 🐛 757 | 🌐 TypeScript | 📅 2026-09-18 - A lightweight management UI for managing your Docker hosts or Docker Swarm clusters.
* [dockge](https://github.com/louislam/dockge) ⭐ 24,393 | 🐛 172 | 🌐 TypeScript | 📅 2026-04-25 - Easy-to-use and reactive self-hosted docker compose.yaml stack-oriented manager.
* [Komodo](https://github.com/mbecker20/komodo) ⭐ 12,351 | 🐛 638 | 🌐 Rust | 📅 2026-09-01 - A tool to build and deploy software on many servers.
* [Arcane](https://github.com/getarcaneapp/arcane) ⭐ 7,450 | 🐛 27 | 🌐 Go | 📅 2026-09-19 - An easy and modern Docker management platform, built with everybody in mind.
* [Swarmpit](https://github.com/swarmpit/swarmpit) ⭐ 3,495 | 🐛 173 | 🌐 Clojure | 📅 2026-08-21 - Swarmpit provides simple and easy to use interface for your Docker Swarm cluster. You can manage your stacks, services, secrets, volumes, networks etc.
...
* [Docker Commander](https://github.com/koduj-dev/docker-commander) ⭐ 3 | 🐛 1 | 🌐 Go | 📅 2026-09-19 - A self-hosted Docker management and monitoring UI with multi-host support, Compose management, aggregated logs, alerts, RBAC, vulnerability scanning, and MCP integration.
...
* [dockerode](https://github.com/apocas/dockerode) ⭐ 4,948 | 🐛 26 | 🌐 JavaScript | 📅 2026-09-13 - Docker Remote API node.js module.
...
* [go-dockerclient](https://github.com/fsouza/go-dockerclient/) ⭐ 2,248 | 🐛 17 | 🌐 Go | 📅 2026-09-14 - Go HTTP client for the Docker remote API.
...
* [Docker Client for JVM](https://github.com/gesellix/docker-client) ⭐ 123 | 🐛 27 | 🌐 Groovy | 📅 2026-09-18 - A Docker remote api client library for the JVM, written in Groovy.
* [Gradle Docker plugin](https://github.com/gesellix/gradle-docker-plugin) ⭐ 82 | 🐛 14 | 🌐 Java | 📅 2026-09-18 - A Docker remote api plugin for Gradle.
...
* [Drone](https://github.com/drone/drone) ⭐ 38,404 | 🐛 111 | 🌐 Go | 📅 2026-09-18 - Continuous integration server built on Docker and configured using YAML files.
* [Diun](https://github.com/crazy-max/diun) ⭐ 4,928 | 🐛 108 | 🌐 Go | 📅 2026-09-03 - Receive notifications when an image or repository is updated on a Docker registry.
* [dockcheck](https://github.com/mag37/dockcheck) ⭐ 2,507 | 🐛 8 | 🌐 Shell | 📅 2026-08-11 - A script checking updates for docker images without pulling then auto-update selected/all containers. With notifications, pruning and more.
...
* [Defang](https://github.com/DefangLabs/defang) ⭐ 166 | 🐛 214 | 🌐 Go | 📅 2026-09-19 - Deploy Docker Compose to your favorite cloud in minutes.
...
* [Self Hosted Runner](https://github.com/youssefbrr/self-hosted-runner) ⭐ 139 | 🐛 1 | 🌐 Dockerfile | 📅 2026-08-31 - Dockerized solution for setting up a self-hosted GitHub Actions runner with support for Linux, macOS, and Windows.
...
* [coder](https://github.com/coder/coder) ⭐ 15,836 | 🐛 1,047 | 🌐 Go | 📅 2026-09-20 - Remote development machines powered by Terraform or Docker.
...
* [DIP](https://github.com/bibendi/dip) ⭐ 1,349 | 🐛 14 | 🌐 Ruby | 📅 2026-09-13 - CLI utility for straightforward provisioning and interacting with an application configured by docker-compose.
...
* [dde](https://github.com/whatwedo/dde) ⭐ 48 | 🐛 16 | 🌐 PHP | 📅 2026-09-20 - Local development environment toolset based on Docker.
* [uniget](https://github.com/uniget-org/cli) ⭐ 24 | 🐛 17 | 🌐 Go | 📅 2026-09-18 - Uni(versal)get, the installer and updater for container tools and beyond (formerly docker-setup).
...
* [OpenFaaS](https://github.com/openfaas/faas) ⭐ 26,244 | 🐛 31 | 🌐 Go | 📅 2026-07-02 - A complete serverless functions framework for Docker and Kubernetes.
* [Apache OpenWhisk](https://github.com/apache/openwhisk) ⭐ 6,796 | 🐛 431 | 🌐 Scala | 📅 2026-09-08 - A serverless, open source cloud platform that executes functions in response to events at any scale.
...
* [dgoss](https://github.com/goss-org/goss/tree/master/extras/dgoss) ⭐ 5,972 | 🐛 57 | 🌐 Go | 📅 2026-09-14 - A fast YAML based tool for validating docker containers.
* [Pumba](https://github.com/alexei-led/pumba) ⭐ 3,166 | 🐛 7 | 🌐 Go | 📅 2026-09-17 - Chaos testing tool for Docker. Can be deployed on kubernetes and CoreOS cluster.
...
* [GoSu](https://github.com/tianon/gosu) ⭐ 5,010 | 🐛 8 | 🌐 Shell | 📅 2026-06-06 - Run this specific application as this specific user and get out of the pipeline (entrypoint script tool).
* [docker-gen](https://github.com/jwilder/docker-gen) ⭐ 4,630 | 🐛 30 | 🌐 Go | 📅 2026-09-07 - Generate files from docker container meta-data.
* [Ofelia](https://github.com/mcuadros/ofelia/) ⭐ 3,992 | 🐛 152 | 🌐 Go | 📅 2026-09-18 - Ofelia is a modern and low footprint job scheduler for docker environments, built on Go. Ofelia aims to be a replacement for the old fashioned cron. Supports configuration from container labels and/or configuration files.
* [supercronic](https://github.com/aptible/supercronic) ⭐ 2,646 | 🐛 54 | 🌐 Go | 📅 2026-08-14 - Crontab-compatible job runner, designed specifically to run in containers.
* [cdebug](https://github.com/iximiuz/cdebug) ⭐ 1,672 | 🐛 18 | 🌐 Go | 📅 2026-01-18 - Swiss-army knife for debugging running containers via ephemeral sidecars; works with Docker, containerd, and Kubernetes.
...
* [dockerize](https://github.com/powerman/dockerize) ⭐ 194 | 🐛 5 | 🌐 Go | 📅 2026-09-18 - Utility to simplify running applications in docker containers.
...
* [Docker Curriculum](https://github.com/prakhar1989/docker-curriculum) ⭐ 6,099 | 🐛 19 | 🌐 CSS | 📅 2026-09-18: A comprehensive tutorial for getting started with Docker. Teaches how to use Docker and deploy dockerized apps on AWS with Elastic Beanstalk and Elastic Container Service.
...
* [Cloud Native Landscape](https://github.com/cncf/landscape) ⭐ 9,995 | 🐛 77 | 📅 2026-09-19
...
* [Awesome Selfhosted](https://github.com/awesome-selfhosted/awesome-selfhosted) ⭐ 320,511 | 🐛 0 | 📅 2026-09-19 list of Free Software network services and web applications which can be hosted locally by running in a classical way (setup local web server and run applications from there) or in a Docker container.
* [Awesome Compose](https://github.com/docker/awesome-compose) ⭐ 46,375 | 🐛 430 | 🌐 HTML | 📅 2026-09-19 - Docker Compose samples.
* [Awesome Sysadmin](https://github.com/n1trux/awesome-sysadmin) ⭐ 35,213 | 🐛 0 | 📅 2026-09-17
...
* [How CVE's are handled on Offical Docker Images](https://github.com/docker-library/official-images/issues/1448) ⭐ 7,007 | 🐛 48 | 🌐 Shell | 📅 2026-09-18
