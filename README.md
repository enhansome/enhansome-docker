...
If you would like to contribute, please read [CONTRIBUTING.md](https://github.com/veggiemonk/awesome-docker/blob/master/.github/CONTRIBUTING.md) ⭐ 36,746 | 🐛 27 | 📅 2026-08-27 first.
...
* [Moby](https://github.com/moby/moby) ⭐ 72,015 | 🐛 3,903 | 🌐 Go | 📅 2026-08-29
* [Docker Compose](https://github.com/docker/compose/) ⭐ 38,078 | 🐛 109 | 🌐 Go | 📅 2026-08-28 - Define and run multi-container applications with Docker.
* [Docker Hub](https://hub.docker.com)
* [Docker Registry][distribution] - The Docker toolset to pack, ship, store, and deliver content

## Engine & Runtime

* [podman](https://github.com/containers/libpod) ⭐ 32,728 | 🐛 1,143 | 🌐 Go | 📅 2026-08-30 - Libpod is a library used to create container pods. Home of Podman.
* [colima](https://github.com/abiosoft/colima) ⭐ 30,566 | 🐛 390 | 🌐 Go | 📅 2026-08-24 - Container runtimes on macOS (and Linux) with minimal setup.
* [containerd](https://github.com/containerd/containerd) ⭐ 21,221 | 🐛 444 | 🌐 Go | 📅 2026-08-28 - An open and reliable container runtime.
* [gVisor](https://github.com/google/gvisor) ⭐ 19,192 | 🐛 840 | 🌐 Go | 📅 2026-08-30 - Application Kernel for Containers.
...
* [youki](https://github.com/youki-dev/youki) ⭐ 7,573 | 🐛 150 | 🌐 Rust | 📅 2026-08-30 - Container runtime written in Rust, implementing the OCI runtime specification.
* [cri-o](https://github.com/cri-o/cri-o) ⭐ 5,654 | 🐛 144 | 🌐 Go | 📅 2026-08-30 - Open Container Initiative-based implementation of Kubernetes Container Runtime Interface.
* [lxc](https://github.com/lxc/lxc) ⭐ 5,251 | 🐛 151 | 🌐 C | 📅 2026-08-20 - LXC - Linux Containers.
...
* [Mocker](https://github.com/us/mocker) ⭐ 338 | 🐛 4 | 🌐 Swift | 📅 2026-08-25 - Docker-compatible container CLI for macOS, built on Apple's Containerization framework.
...
* [BuildKit](https://github.com/moby/buildkit) ⭐ 10,215 | 🐛 911 | 🌐 Go | 📅 2026-08-28 - Concurrent, cache-efficient, and Dockerfile-agnostic builder toolkit.
* [buildah](https://github.com/containers/buildah) ⭐ 8,999 | 🐛 289 | 🌐 Go | 📅 2026-08-29 - A tool that facilitates building OCI images.
* [ko](https://github.com/ko-build/ko) ⭐ 8,516 | 🐛 56 | 🌐 Go | 📅 2026-08-26 - Build and deploy Go applications as container images without a Dockerfile.
* [buildx](https://github.com/docker/buildx) ⭐ 4,491 | 🐛 390 | 🌐 Go | 📅 2026-08-28 - Official Docker CLI plugin for multi-platform builds backed by BuildKit.
...
* [runlike](https://github.com/lavie/runlike) ⭐ 2,939 | 🐛 8 | 🌐 Python | 📅 2026-04-27 - Generate `docker run`command and options from running containers.
* [apko](https://github.com/chainguard-dev/apko) ⭐ 1,669 | 🐛 152 | 🌐 Go | 📅 2026-08-28 - Declarative OCI image builder from apk packages; reproducible by design.
...
* [RAUDI](https://github.com/cybersecsi/RAUDI) ⭐ 560 | 🐛 1 | 🌐 Python | 📅 2026-08-30 - A tool to automatically update (and optionally push to Docker Hub) Docker Images for 3rd party software whenever theres is a new release/update/commit.
* [HPC Container Maker](https://github.com/NVIDIA/hpc-container-maker) ⭐ 517 | 🐛 11 | 🌐 Python | 📅 2026-08-28 - Generates Dockerfiles from a high level Python recipe, including building blocks for High-Performance Computing components.
...
* [distroless](https://github.com/GoogleContainerTools/distroless) ⭐ 23,044 | 🐛 14 | 🌐 Starlark | 📅 2026-08-28 - Language focused docker images, minus the operating system.
* [Wolfi](https://github.com/wolfi-dev/os) ⭐ 1,280 | 🐛 83 | 🌐 Shell | 📅 2026-08-30 - Undistro Linux designed for containers; glibc-based, signed, daily SBOMs.
* [Chainguard Images](https://github.com/chainguard-images/images) ⭐ 692 | 🐛 114 | 🌐 HCL | 📅 2026-08-30 - Minimal, signed, SBOM-attested container images built on Wolfi.
* [melange](https://github.com/chainguard-dev/melange) ⭐ 623 | 🐛 261 | 🌐 Go | 📅 2026-08-27 - Build apk packages from declarative YAML for use with apko.
* [pglayers](https://github.com/pglayers/pglayers) ⭐ 152 | 🐛 2 | 🌐 Dockerfile | 📅 2026-08-27 - Pre-built PostgreSQL extensions as composable Docker layers. 50+ extensions, ready-to-use combined images (full, Azure-compatible).
...
* [Dockershelf](https://github.com/Dockershelf/dockershelf) ⭐ 98 | 🐛 0 | 🌐 Shell | 📅 2026-08-14 - A repository that serves as a collector for docker recipes that are universal, efficient and slim. Images are updated, tested and published daily via a Travis cron job.
* [Dofigen](https://github.com/lenra-io/dofigen) ⭐ 73 | 🐛 26 | 🌐 Rust | 📅 2026-08-17 - A Dockerfile generator using a simplified description in YAML or JSON format.
...
* [Hadolint](https://github.com/hadolint/hadolint) ⭐ 12,377 | 🐛 203 | 🌐 Haskell | 📅 2026-08-24 - A Dockerfile linter that checks for best practices, common mistakes, and is also able to lint any bash written in `RUN` instructions;.
...
* [docker-image-size-limit](https://github.com/wemake-services/docker-image-size-limit) ⭐ 133 | 🐛 1 | 🌐 Python | 📅 2026-08-26 - A tool to keep an eye on your docker images size.
...
* [Harbor](https://github.com/goharbor/harbor) ⭐ 29,258 | 🐛 871 | 🌐 Go | 📅 2026-08-29 An open source trusted cloud native registry project that stores, signs, and scans content. Supports replication, user management, access control and activity auditing.
* [Kraken](https://github.com/uber/kraken) ⭐ 6,739 | 🐛 116 | 🌐 Go | 📅 2026-08-26 - Uber's Highly scalable P2P docker registry, capable of distributing TBs of data in seconds.
* [Dragonfly](https://github.com/dragonflyoss/Dragonfly2) ⭐ 3,313 | 🐛 28 | 🌐 Go | 📅 2026-08-28 - Provide efficient, stable and secure file distribution and image acceleration based on p2p technology.
* [NORA](https://github.com/getnora-io/nora) ⭐ 291 | 🐛 24 | 🌐 Rust | 📅 2026-08-30 - Lightweight multi-protocol artifact registry supporting Docker, Maven, npm, Cargo and PyPI in a single 32MB binary. Pull-through cache, Web UI, Prometheus metrics, RBAC auth.
...
* [skopeo](https://github.com/containers/skopeo) ⭐ 11,197 | 🐛 90 | 🌐 Go | 📅 2026-08-28 - Work with remote image registries: retrieve information, copy images, sign content.
* [crane](https://github.com/google/go-containerregistry/tree/main/cmd/crane) ⭐ 4,027 | 🐛 171 | 🌐 Go | 📅 2026-08-28 - Lightweight CLI to manipulate registry images, from `go-containerregistry`.
* [go-containerregistry](https://github.com/google/go-containerregistry) ⭐ 4,027 | 🐛 171 | 🌐 Go | 📅 2026-08-28 - Go library and CLI tools (`crane`, `gcrane`, `registry`) for working with container registries.
* [oras](https://github.com/oras-project/oras) ⭐ 2,407 | 🐛 74 | 🌐 Go | 📅 2026-08-28 - Push and pull arbitrary OCI artifacts to and from any OCI registry.
* [regctl](https://github.com/regclient/regclient) ⭐ 1,920 | 🐛 23 | 🌐 Go | 📅 2026-08-29 - Daemonless registry client; copy, inspect, modify, and sign OCI images.

### Image Scanning & SBOM

Image vulnerability scanners, SBOM generators, and digest pinning tools. Commercial entries marked `:yen:`.

* [Trivy](https://github.com/aquasecurity/trivy) ⭐ 37,695 | 🐛 258 | 🌐 Go | 📅 2026-08-28 - Aqua Security's open source simple and comprehensive vulnerability scanner for containers (suitable for CI).
* [Grype](https://github.com/anchore/grype) ⭐ 12,805 | 🐛 404 | 🌐 Go | 📅 2026-08-28 - A vulnerability scanner for container images, filesystems and SBOMs.
* [Clair](https://github.com/quay/clair) ⭐ 11,054 | 🐛 59 | 🌐 Go | 📅 2026-08-25 - Clair is an open source project for the static analysis of vulnerabilities in appc and docker containers.
* [Syft](https://github.com/anchore/syft) ⭐ 9,479 | 🐛 631 | 🌐 Go | 📅 2026-08-29 - CLI tool and library for generating a Software Bill of Materials (SBOM) from container images and filesystems.
* [oscap-docker](https://github.com/OpenSCAP/openscap) ⭐ 1,806 | 🐛 63 | 🌐 XSLT | 📅 2026-08-13 - OpenSCAP provides oscap-docker tool which is used to scan Docker containers and images.
...
* [BomLens](https://github.com/sktelecom/bomlens) ⭐ 17 | 🐛 4 | 🌐 Shell | 📅 2026-08-30 - Scan container images (plus source, binaries, and firmware) into CycloneDX SBOMs with vulnerability, license, and notice reports. Ships as a single Docker image with a web UI.
...
* [cosign](https://github.com/sigstore/cosign) ⭐ 6,266 | 🐛 172 | 🌐 Go | 📅 2026-08-24 - Container signing, verification, and transparency log for OCI artifacts.
...
* [witness](https://github.com/in-toto/witness) ⭐ 546 | 🐛 77 | 🌐 Go | 📅 2026-08-24 - Generate and verify in-toto attestations across the build pipeline.
...
* [kompose](https://github.com/kubernetes/kompose) ⭐ 10,619 | 🐛 21 | 🌐 Go | 📅 2026-08-27 - Go from Docker Compose to Kubernetes.
* [podman-compose](https://github.com/containers/podman-compose) ⭐ 6,206 | 🐛 336 | 🌐 Python | 📅 2026-08-11 - A script to run docker-compose.yml using podman.
...
* [Kubernetes](https://github.com/kubernetes/kubernetes) ⭐ 125,573 | 🐛 2,994 | 🌐 Go | 📅 2026-08-28 - Open source orchestration system for Docker containers by Google.
* [Rancher](https://github.com/rancher/rancher) ⭐ 25,883 | 🐛 3,340 | 🌐 Go | 📅 2026-08-29 - An open source project that provides a complete platform for operating Docker in production.
* [Nomad](https://github.com/hashicorp/nomad) ⭐ 16,845 | 🐛 1,639 | 🌐 Go | 📅 2026-08-28 - Easily deploy applications at any scale. A Distributed, Highly Available, Datacenter-Aware Scheduler.
...
* [Dokku](https://github.com/dokku/dokku) ⭐ 32,117 | 🐛 26 | 🌐 Shell | 📅 2026-08-30 - Docker powered mini-Heroku that helps you build and manage the lifecycle of applications.
* [caprover](https://github.com/caprover/caprover) ⭐ 15,150 | 🐛 176 | 🌐 TypeScript | 📅 2026-08-20 - \[Previously known as CaptainDuckDuck] Automated Scalable Webserver Package (automated Docker+nginx) - Heroku on Steroids.
* [Tsuru](https://github.com/tsuru/tsuru) ⭐ 5,307 | 🐛 20 | 🌐 Go | 📅 2026-08-25 - Tsuru is an extensible and open source Platform as a Service software.
* [werf](https://github.com/werf/werf) ⭐ 4,720 | 🐛 29 | 🌐 Go | 📅 2026-08-29 - Werf is a CI/CD tool for building Docker images efficiently and deploying them to Kubernetes using GitOps.
...
* [doco-cd](https://github.com/kimdre/doco-cd) ⭐ 1,643 | 🐛 12 | 🌐 Go | 📅 2026-08-30 - Lightweight GitOps and Continuous Deployment tool to deploy Docker Compose projects and Swarm stacks using polling and webhooks.
...
* [OpenRun](https://github.com/openrundev/openrun) ⭐ 951 | 🐛 1 | 🌐 Go | 📅 2026-08-29 - Builds, deploys, proxies, authenticates and auto-pauses web apps with Docker or Kubernetes.
...
* [docker-to-iac](https://github.com/deploystackio/docker-to-iac) ⭐ 22 | 🐛 14 | 🌐 TypeScript | 📅 2026-08-24 - Translate docker run and commit into Infrastructure as Code templates for AWS, Render.com and DigitalOcean.
...
* [Docuum](https://github.com/stepchowfun/docuum) ⭐ 709 | 🐛 12 | 🌐 Rust | 📅 2026-08-28 - Least recently used (LRU) eviction of Docker images.
...
* [netshoot](https://github.com/nicolaka/netshoot) ⭐ 10,963 | 🐛 43 | 🌐 Shell | 📅 2026-07-01 - The netshoot container has a powerful set of networking tools to help troubleshoot Docker networking issues.
* [Flannel](https://github.com/coreos/flannel/) ⭐ 9,528 | 🐛 24 | 🌐 Go | 📅 2026-08-28 - Flannel is a virtual network that gives a subnet to each host for use with container runtimes.
...
* [Træfɪk](https://github.com/containous/traefik) ⭐ 64,665 | 🐛 915 | 🌐 Go | 📅 2026-08-30 - Automated reverse proxy and load-balancer for Docker, Mesos, Consul, Etcd.
* [Nginx Proxy Manager](https://github.com/jc21/nginx-proxy-manager) ⭐ 34,024 | 🐛 899 | 🌐 TypeScript | 📅 2026-08-29 - A beautiful web interface for proxying web based services with SSL.
* [BunkerWeb](https://github.com/bunkerity/bunkerweb) ⭐ 10,883 | 🐛 157 | 🌐 Python | 📅 2026-08-28 - Open-source and next-gen Web Application Firewall (WAF).
...
* [Docker Volume Backup](https://github.com/offen/docker-volume-backup) ⭐ 3,992 | 🐛 27 | 🌐 Go | 📅 2026-08-25 Backup Docker volumes locally or to any S3 compatible storage.
...
* [Drydock](https://github.com/CodesWhat/drydock) ⭐ 246 | 🐛 7 | 🌐 TypeScript | 📅 2026-08-30 - Container update monitoring with web dashboard, 23 registry providers, 20 notification triggers, and distributed agent architecture.
* [InfraCanvas](https://github.com/bytestrix/InfraCanvas) ⭐ 77 | 🐛 7 | 🌐 Go | 📅 2026-08-25 - Live visual map of containers, pods, volumes, and networks on any Linux server. Single binary, WebSocket-powered live updates.
...
* [DLIA](https://github.com/zorak1103/dlia) ⭐ 7 | 🐛 1 | 🌐 Go | 📅 2026-08-29 - DLIA is an AI-powered Docker log monitoring agent that uses Large Language Models (LLMs) to intelligently analyze container logs, detect anomalies, and provide contextual insights over time.
...
* [docker-exporter](https://github.com/dlepaux/docker-exporter) ⭐ 3 | 🐛 11 | 🌐 Rust | 📅 2026-08-27 - Lightweight Prometheus exporter for Docker container metrics written in Rust. Correct cgroup v2 memory working set on ARM64 (Raspberry Pi 5), runs non-root with a read-only socket, \~7 MiB idle RAM.
...
* [Sysdig Falco](https://github.com/falcosecurity/falco) ⭐ 9,314 | 🐛 65 | 🌐 C++ | 📅 2026-08-03 - Sysdig Falco is an open source container security monitor. It can monitor application, container, host, and network activity and alert on unauthorized activity.
* [Checkov](https://github.com/bridgecrewio/checkov) ⭐ 8,976 | 🐛 166 | 🌐 Python | 📅 2026-08-30 - Static analysis for infrastructure as code manifests (Terraform, Kubernetes, Cloudformation, Helm, Dockerfile, Kustomize) find security misconfiguration and fix them.
...
* [docker-socket-proxy](https://github.com/Tecnativa/docker-socket-proxy) ⭐ 2,739 | 🐛 50 | 🌐 Python | 📅 2026-07-27 - HAProxy-based fine-grained filter for the Docker API socket; widely used to expose a restricted socket to reverse proxies and homelab stacks.
* [KICS](https://github.com/checkmarx/kics) ⭐ 2,697 | 🐛 315 | 🌐 Open Policy Agent | 📅 2026-08-25 - An infrastructure-as-code scanning tool, find security vulnerabilities, compliance issues, and infrastructure misconfigurations early in the development cycle. Can be extended for additional policies.
...
* [compose-lint](https://github.com/tmatens/compose-lint) ⭐ 53 | 🐛 7 | 🌐 Python | 📅 2026-08-29 - Lints Docker Compose files for security misconfigurations — privileged containers, unpinned images, Docker socket mounts, plaintext credentials — grounded in OWASP and the CIS Docker Benchmark.
...
* [Den](https://github.com/us/den) ⭐ 15 | 🐛 0 | 🌐 Go | 📅 2026-06-18 - Self-hosted sandbox runtime for AI agents with Docker containers, security hardening, REST API and WebSocket support.
* [buildcage](https://github.com/dash14/buildcage) ⭐ 11 | 🐛 1 | 🌐 TypeScript | 📅 2026-08-30 - Restricts outbound network access during Docker builds to prevent supply chain attacks, working as a drop-in BuildKit remote driver for Docker Buildx, with ready-to-use GitHub Actions.
...
* [Stevedore](https://github.com/slonopotamus/stevedore) ⭐ 382 | 🐛 2 | 🌐 Rust | 📅 2026-08-30 - Good Docker Desktop replacement for Windows. Both Linux and Windows Containers are supported. [slonopotamus](https://github.com/slonopotamus).
...
* [Gantry (Desktop)](https://github.com/getgantry/gantry) ⭐ 59 | 🐛 4 | 🌐 Swift | 📅 2026-08-10 - Native macOS app (SwiftUI, no Electron) for managing and monitoring Docker hosts, local and over SSH: fleet dashboard, live logs and stats, exec terminal, file browser, and a bundled MCP server for AI agents.
...
* [dive](https://github.com/wagoodman/dive) ⭐ 54,518 | 🐛 212 | 🌐 Go | 📅 2025-12-15 - A tool for exploring each layer in a docker image.
* [lazydocker](https://github.com/jesseduffield/lazydocker) ⭐ 52,662 | 🐛 297 | 🌐 Go | 📅 2026-04-19 - The lazier way to manage everything docker. A simple terminal UI for both docker and docker-compose, written in Go with the gocui library.
...
* [DockSTARTer](https://github.com/GhostWriters/DockSTARTer) ⭐ 2,570 | 🐛 4 | 🌐 Shell | 📅 2026-08-29 - DockSTARTer helps you get started with home server apps running in Docker.
...
* [Portainer](https://github.com/portainer/portainer) ⭐ 38,379 | 🐛 745 | 🌐 TypeScript | 📅 2026-08-28 - A lightweight management UI for managing your Docker hosts or Docker Swarm clusters.
* [dockge](https://github.com/louislam/dockge) ⭐ 24,208 | 🐛 168 | 🌐 TypeScript | 📅 2026-04-25 - Easy-to-use and reactive self-hosted docker compose.yaml stack-oriented manager.
* [Komodo](https://github.com/mbecker20/komodo) ⭐ 12,122 | 🐛 616 | 🌐 Rust | 📅 2026-08-27 - A tool to build and deploy software on many servers.
* [Arcane](https://github.com/getarcaneapp/arcane) ⭐ 7,187 | 🐛 143 | 🌐 Go | 📅 2026-08-30 - An easy and modern Docker management platform, built with everybody in mind.
...
* [docker-swarm-visualizer](https://github.com/dockersamples/docker-swarm-visualizer) ⭐ 3,339 | 🐛 11 | 🌐 JavaScript | 📅 2024-10-26 - Visualizes Docker services on a Docker Swarm (for running demos).
...
* [Docker Commander](https://github.com/koduj-dev/docker-commander) ⭐ 3 | 🐛 3 | 🌐 Go | 📅 2026-08-28 - A self-hosted Docker management and monitoring UI with multi-host support, Compose management, aggregated logs, alerts, RBAC, vulnerability scanning, and MCP integration.
...
* [dockerode](https://github.com/apocas/dockerode) ⭐ 4,942 | 🐛 25 | 🌐 JavaScript | 📅 2026-08-10 - Docker Remote API node.js module.
...
* [go-dockerclient](https://github.com/fsouza/go-dockerclient/) ⭐ 2,244 | 🐛 15 | 🌐 Go | 📅 2026-08-24 - Go HTTP client for the Docker remote API.
* [docker-maven-plugin](https://github.com/fabric8io/docker-maven-plugin) ⭐ 1,933 | 🐛 517 | 🌐 Java | 📅 2026-08-30 - A Maven plugin for running and creating Docker images.
...
* [Drone](https://github.com/drone/drone) ⭐ 38,171 | 🐛 103 | 🌐 Go | 📅 2026-08-28 - Continuous integration server built on Docker and configured using YAML files.
* [Diun](https://github.com/crazy-max/diun) ⭐ 4,891 | 🐛 104 | 🌐 Go | 📅 2026-08-11 - Receive notifications when an image or repository is updated on a Docker registry.
* [dockcheck](https://github.com/mag37/dockcheck) ⭐ 2,492 | 🐛 9 | 🌐 Shell | 📅 2026-08-11 - A script checking updates for docker images without pulling then auto-update selected/all containers. With notifications, pruning and more.
...
* [Defang](https://github.com/DefangLabs/defang) ⭐ 164 | 🐛 214 | 🌐 Go | 📅 2026-08-28 - Deploy Docker Compose to your favorite cloud in minutes.
...
* [Self Hosted Runner](https://github.com/youssefbrr/self-hosted-runner) ⭐ 133 | 🐛 0 | 🌐 Dockerfile | 📅 2026-07-18 - Dockerized solution for setting up a self-hosted GitHub Actions runner with support for Linux, macOS, and Windows.
...
* [coder](https://github.com/coder/coder) ⭐ 14,299 | 🐛 964 | 🌐 Go | 📅 2026-08-30 - Remote development machines powered by Terraform or Docker.
* [Laradock](https://github.com/laradock/laradock) ⭐ 12,673 | 🐛 16 | 🌐 Dockerfile | 📅 2026-08-16 - Full PHP development environment based on Docker, running Nginx/Apache, PHP, MySQL, Redis and more as swappable Compose services.
...
* [DIP](https://github.com/bibendi/dip) ⭐ 1,349 | 🐛 15 | 🌐 Ruby | 📅 2026-05-23 - CLI utility for straightforward provisioning and interacting with an application configured by docker-compose.
...
* [dde](https://github.com/whatwedo/dde) ⭐ 48 | 🐛 11 | 🌐 PHP | 📅 2026-08-30 - Local development environment toolset based on Docker.
...
* [OpenFaaS](https://github.com/openfaas/faas) ⭐ 26,230 | 🐛 31 | 🌐 Go | 📅 2026-07-02 - A complete serverless functions framework for Docker and Kubernetes.
...
* [Pumba](https://github.com/alexei-led/pumba) ⭐ 3,141 | 🐛 3 | 🌐 Go | 📅 2026-08-27 - Chaos testing tool for Docker. Can be deployed on kubernetes and CoreOS cluster.
...
* [udocker](https://github.com/indigo-dc/udocker) ⭐ 1,783 | 🐛 40 | 🌐 Python | 📅 2025-08-13 - A tool to execute simple docker containers in batch or interactive systems without root privileges.
...
* [GoSu](https://github.com/tianon/gosu) ⭐ 5,003 | 🐛 8 | 🌐 Shell | 📅 2026-06-06 - Run this specific application as this specific user and get out of the pipeline (entrypoint script tool).
* [docker-gen](https://github.com/jwilder/docker-gen) ⭐ 4,631 | 🐛 28 | 🌐 Go | 📅 2026-08-30 - Generate files from docker container meta-data.
* [Ofelia](https://github.com/mcuadros/ofelia/) ⭐ 3,972 | 🐛 148 | 🌐 Go | 📅 2026-08-29 - Ofelia is a modern and low footprint job scheduler for docker environments, built on Go. Ofelia aims to be a replacement for the old fashioned cron. Supports configuration from container labels and/or configuration files.
* [supercronic](https://github.com/aptible/supercronic) ⭐ 2,620 | 🐛 55 | 🌐 Go | 📅 2026-08-14 - Crontab-compatible job runner, designed specifically to run in containers.
* [cdebug](https://github.com/iximiuz/cdebug) ⭐ 1,666 | 🐛 18 | 🌐 Go | 📅 2026-01-18 - Swiss-army knife for debugging running containers via ephemeral sidecars; works with Docker, containerd, and Kubernetes.
...
* [Docker Curriculum](https://github.com/prakhar1989/docker-curriculum) ⭐ 6,089 | 🐛 17 | 🌐 CSS | 📅 2026-08-12: A comprehensive tutorial for getting started with Docker. Teaches how to use Docker and deploy dockerized apps on AWS with Elastic Beanstalk and Elastic Container Service.
...
* [Cloud Native Landscape](https://github.com/cncf/landscape) ⭐ 9,983 | 🐛 79 | 📅 2026-08-30
...
* [Awesome Selfhosted](https://github.com/awesome-selfhosted/awesome-selfhosted) ⭐ 316,122 | 🐛 0 | 📅 2026-08-30 list of Free Software network services and web applications which can be hosted locally by running in a classical way (setup local web server and run applications from there) or in a Docker container.
* [Awesome Compose](https://github.com/docker/awesome-compose) ⭐ 46,199 | 🐛 417 | 🌐 HTML | 📅 2026-08-25 - Docker Compose samples.
* [Awesome Sysadmin](https://github.com/n1trux/awesome-sysadmin) ⭐ 35,023 | 🐛 0 | 📅 2026-08-29
* [ToolsOfTheTrade](https://github.com/cjbarber/ToolsOfTheTrade) ⭐ 17,161 | 🐛 17 | 📅 2026-05-16 a list of SaaS and On premise applications
* [Awesome Kubernetes](https://github.com/ramitsurana/awesome-kubernetes) ⭐ 16,062 | 🐛 83 | 🌐 Shell | 📅 2026-06-23
* [Awesome Linux Container](https://github.com/Friz-zy/awesome-linux-containers) ⭐ 2,093 | 🐛 11 | 📅 2024-04-09 more general about container than this repo.
...
* [How CVE's are handled on Offical Docker Images](https://github.com/docker-library/official-images/issues/1448) ⭐ 6,994 | 🐛 50 | 🌐 Shell | 📅 2026-08-28
