...
If you would like to contribute, please read [CONTRIBUTING.md](https://github.com/veggiemonk/awesome-docker/blob/master/.github/CONTRIBUTING.md) ⭐ 36,762 | 🐛 27 | 📅 2026-08-27 first.
...
* [Moby](https://github.com/moby/moby) ⭐ 72,030 | 🐛 3,887 | 🌐 Go | 📅 2026-09-02
* [Docker Compose](https://github.com/docker/compose/) ⭐ 38,117 | 🐛 113 | 🌐 Go | 📅 2026-09-02 - Define and run multi-container applications with Docker.
* [Docker Hub](https://hub.docker.com)
* [Docker Registry][distribution] - The Docker toolset to pack, ship, store, and deliver content

## Engine & Runtime

* [podman](https://github.com/containers/libpod) ⭐ 32,757 | 🐛 1,133 | 🌐 Go | 📅 2026-09-02 - Libpod is a library used to create container pods. Home of Podman.
* [colima](https://github.com/abiosoft/colima) ⭐ 30,607 | 🐛 389 | 🌐 Go | 📅 2026-08-31 - Container runtimes on macOS (and Linux) with minimal setup.
* [containerd](https://github.com/containerd/containerd) ⭐ 21,239 | 🐛 450 | 🌐 Go | 📅 2026-09-02 - An open and reliable container runtime.
* [gVisor](https://github.com/google/gvisor) ⭐ 19,218 | 🐛 865 | 🌐 Go | 📅 2026-09-02 - Application Kernel for Containers.
* [runc](https://github.com/opencontainers/runc) ⭐ 13,428 | 🐛 346 | 🌐 Go | 📅 2026-09-01 - CLI tool for spawning and running containers according to the OCI specification.
...
* [cri-o](https://github.com/cri-o/cri-o) ⭐ 5,655 | 🐛 143 | 🌐 Go | 📅 2026-09-02 - Open Container Initiative-based implementation of Kubernetes Container Runtime Interface.
* [lxc](https://github.com/lxc/lxc) ⭐ 5,252 | 🐛 148 | 🌐 C | 📅 2026-08-31 - LXC - Linux Containers.
...
* [DockerSlim](https://github.com/docker-slim/docker-slim) ⭐ 23,408 | 🐛 211 | 🌐 Go | 📅 2026-08-02 shrinks fat Docker images creating the smallest possible images.
...
* [BuildKit](https://github.com/moby/buildkit) ⭐ 10,225 | 🐛 909 | 🌐 Go | 📅 2026-09-02 - Concurrent, cache-efficient, and Dockerfile-agnostic builder toolkit.
* [buildah](https://github.com/containers/buildah) ⭐ 9,000 | 🐛 285 | 🌐 Go | 📅 2026-09-02 - A tool that facilitates building OCI images.
* [ko](https://github.com/ko-build/ko) ⭐ 8,515 | 🐛 57 | 🌐 Go | 📅 2026-09-02 - Build and deploy Go applications as container images without a Dockerfile.
* [buildx](https://github.com/docker/buildx) ⭐ 4,492 | 🐛 387 | 🌐 Go | 📅 2026-09-02 - Official Docker CLI plugin for multi-platform builds backed by BuildKit.
...
* [runlike](https://github.com/lavie/runlike) ⭐ 2,941 | 🐛 8 | 🌐 Python | 📅 2026-04-27 - Generate `docker run`command and options from running containers.
* [apko](https://github.com/chainguard-dev/apko) ⭐ 1,670 | 🐛 152 | 🌐 Go | 📅 2026-09-02 - Declarative OCI image builder from apk packages; reproducible by design.
* [Whaler](https://github.com/P3GLEG/Whaler) ⭐ 1,191 | 🐛 8 | 🌐 Go | 📅 2026-04-08 - Program to reverse Docker images into Dockerfiles.
* [nix2container](https://github.com/nlewo/nix2container) ⭐ 903 | 🐛 86 | 🌐 Go | 📅 2026-04-06 - Build OCI images with Nix without `docker load` round-trips.
...
* [RAUDI](https://github.com/cybersecsi/RAUDI) ⭐ 560 | 🐛 1 | 🌐 Python | 📅 2026-09-02 - A tool to automatically update (and optionally push to Docker Hub) Docker Images for 3rd party software whenever theres is a new release/update/commit.
...
* [dlayer](https://github.com/orisano/dlayer) ⭐ 447 | 🐛 6 | 🌐 Go | 📅 2026-09-01 - Docker layer analyzer.
...
* [distroless](https://github.com/GoogleContainerTools/distroless) ⭐ 23,053 | 🐛 14 | 🌐 Starlark | 📅 2026-09-01 - Language focused docker images, minus the operating system.
* [Wolfi](https://github.com/wolfi-dev/os) ⭐ 1,283 | 🐛 83 | 🌐 Shell | 📅 2026-09-01 - Undistro Linux designed for containers; glibc-based, signed, daily SBOMs.
* [Chainguard Images](https://github.com/chainguard-images/images) ⭐ 692 | 🐛 114 | 🌐 HCL | 📅 2026-09-02 - Minimal, signed, SBOM-attested container images built on Wolfi.
* [melange](https://github.com/chainguard-dev/melange) ⭐ 623 | 🐛 261 | 🌐 Go | 📅 2026-09-02 - Build apk packages from declarative YAML for use with apko.
* [pglayers](https://github.com/pglayers/pglayers) ⭐ 153 | 🐛 4 | 🌐 Dockerfile | 📅 2026-09-02 - Pre-built PostgreSQL extensions as composable Docker layers. 50+ extensions, ready-to-use combined images (full, Azure-compatible).
...
* [Hadolint](https://github.com/hadolint/hadolint) ⭐ 12,382 | 🐛 203 | 🌐 Haskell | 📅 2026-08-24 - A Dockerfile linter that checks for best practices, common mistakes, and is also able to lint any bash written in `RUN` instructions;.
...
* [Harbor](https://github.com/goharbor/harbor) ⭐ 29,291 | 🐛 875 | 🌐 Go | 📅 2026-09-02 An open source trusted cloud native registry project that stores, signs, and scans content. Supports replication, user management, access control and activity auditing.
...
* [Dragonfly](https://github.com/dragonflyoss/Dragonfly2) ⭐ 3,316 | 🐛 28 | 🌐 Go | 📅 2026-09-02 - Provide efficient, stable and secure file distribution and image acceleration based on p2p technology.
...
* [crane](https://github.com/google/go-containerregistry/tree/main/cmd/crane) ⭐ 4,028 | 🐛 152 | 🌐 Go | 📅 2026-09-02 - Lightweight CLI to manipulate registry images, from `go-containerregistry`.
* [go-containerregistry](https://github.com/google/go-containerregistry) ⭐ 4,028 | 🐛 152 | 🌐 Go | 📅 2026-09-02 - Go library and CLI tools (`crane`, `gcrane`, `registry`) for working with container registries.
* [oras](https://github.com/oras-project/oras) ⭐ 2,411 | 🐛 75 | 🌐 Go | 📅 2026-09-01 - Push and pull arbitrary OCI artifacts to and from any OCI registry.
* [regctl](https://github.com/regclient/regclient) ⭐ 1,923 | 🐛 24 | 🌐 Go | 📅 2026-09-01 - Daemonless registry client; copy, inspect, modify, and sign OCI images.

### Image Scanning & SBOM

Image vulnerability scanners, SBOM generators, and digest pinning tools. Commercial entries marked `:yen:`.

* [Trivy](https://github.com/aquasecurity/trivy) ⭐ 37,742 | 🐛 268 | 🌐 Go | 📅 2026-09-02 - Aqua Security's open source simple and comprehensive vulnerability scanner for containers (suitable for CI).
* [Grype](https://github.com/anchore/grype) ⭐ 12,822 | 🐛 405 | 🌐 Go | 📅 2026-09-02 - A vulnerability scanner for container images, filesystems and SBOMs.
* [Clair](https://github.com/quay/clair) ⭐ 11,054 | 🐛 61 | 🌐 Go | 📅 2026-09-02 - Clair is an open source project for the static analysis of vulnerabilities in appc and docker containers.
* [Syft](https://github.com/anchore/syft) ⭐ 9,502 | 🐛 630 | 🌐 Go | 📅 2026-09-02 - CLI tool and library for generating a Software Bill of Materials (SBOM) from container images and filesystems.
* [oscap-docker](https://github.com/OpenSCAP/openscap) ⭐ 1,809 | 🐛 64 | 🌐 XSLT | 📅 2026-09-01 - OpenSCAP provides oscap-docker tool which is used to scan Docker containers and images.
...
* [BomLens](https://github.com/sktelecom/bomlens) ⭐ 17 | 🐛 4 | 🌐 Shell | 📅 2026-09-02 - Scan container images (plus source, binaries, and firmware) into CycloneDX SBOMs with vulnerability, license, and notice reports. Ships as a single Docker image with a web UI.
...
* [cosign](https://github.com/sigstore/cosign) ⭐ 6,276 | 🐛 181 | 🌐 Go | 📅 2026-09-02 - Container signing, verification, and transparency log for OCI artifacts.
...
* [witness](https://github.com/in-toto/witness) ⭐ 546 | 🐛 78 | 🌐 Go | 📅 2026-09-02 - Generate and verify in-toto attestations across the build pipeline.
...
* [kompose](https://github.com/kubernetes/kompose) ⭐ 10,618 | 🐛 21 | 🌐 Go | 📅 2026-08-31 - Go from Docker Compose to Kubernetes.
* [podman-compose](https://github.com/containers/podman-compose) ⭐ 6,209 | 🐛 336 | 🌐 Python | 📅 2026-08-11 - A script to run docker-compose.yml using podman.
...
* [Kubernetes](https://github.com/kubernetes/kubernetes) ⭐ 125,939 | 🐛 3,024 | 🌐 Go | 📅 2026-09-02 - Open source orchestration system for Docker containers by Google.
* [Rancher](https://github.com/rancher/rancher) ⭐ 25,885 | 🐛 3,343 | 🌐 Go | 📅 2026-09-02 - An open source project that provides a complete platform for operating Docker in production.
* [Nomad](https://github.com/hashicorp/nomad) ⭐ 16,852 | 🐛 1,634 | 🌐 Go | 📅 2026-09-02 - Easily deploy applications at any scale. A Distributed, Highly Available, Datacenter-Aware Scheduler.
* [Mesos](https://github.com/apache/mesos) ⭐ 5,368 | 🐛 11 | 🌐 C++ | 📅 2026-05-15 - Resource/Job scheduler for containers, VM's and physical hosts.
* [docker rollout](https://github.com/Wowu/docker-rollout) ⭐ 3,323 | 🐛 8 | 🌐 Shell | 📅 2026-07-12 - Zero downtime deployment for Docker Compose services.
* [Swarm-cronjob](https://github.com/crazy-max/swarm-cronjob) ⭐ 882 | 🐛 37 | 🌐 Go | 📅 2026-09-02 - Create jobs on a time-based schedule on Swarm.
...
* [Dokku](https://github.com/dokku/dokku) ⭐ 32,122 | 🐛 41 | 🌐 Shell | 📅 2026-09-02 - Docker powered mini-Heroku that helps you build and manage the lifecycle of applications.
...
* [Tsuru](https://github.com/tsuru/tsuru) ⭐ 5,309 | 🐛 19 | 🌐 Go | 📅 2026-09-02 - Tsuru is an extensible and open source Platform as a Service software.
* [werf](https://github.com/werf/werf) ⭐ 4,720 | 🐛 31 | 🌐 Go | 📅 2026-09-02 - Werf is a CI/CD tool for building Docker images efficiently and deploying them to Kubernetes using GitOps.
...
* [doco-cd](https://github.com/kimdre/doco-cd) ⭐ 1,648 | 🐛 11 | 🌐 Go | 📅 2026-09-02 - Lightweight GitOps and Continuous Deployment tool to deploy Docker Compose projects and Swarm stacks using polling and webhooks.
...
* [OpenRun](https://github.com/openrundev/openrun) ⭐ 965 | 🐛 1 | 🌐 Go | 📅 2026-09-01 - Builds, deploys, proxies, authenticates and auto-pauses web apps with Docker or Kubernetes.
...
* [Flannel](https://github.com/coreos/flannel/) ⭐ 9,529 | 🐛 26 | 🌐 Go | 📅 2026-09-02 - Flannel is a virtual network that gives a subnet to each host for use with container runtimes.
...
* [Træfɪk](https://github.com/containous/traefik) ⭐ 64,710 | 🐛 912 | 🌐 Go | 📅 2026-09-01 - Automated reverse proxy and load-balancer for Docker, Mesos, Consul, Etcd.
* [Nginx Proxy Manager](https://github.com/jc21/nginx-proxy-manager) ⭐ 34,050 | 🐛 889 | 🌐 TypeScript | 📅 2026-09-01 - A beautiful web interface for proxying web based services with SSL.
* [BunkerWeb](https://github.com/bunkerity/bunkerweb) ⭐ 10,893 | 🐛 162 | 🌐 Python | 📅 2026-09-02 - Open-source and next-gen Web Application Firewall (WAF).
...
* [caddy-docker-proxy](https://github.com/lucaslorentz/caddy-docker-proxy) ⭐ 4,637 | 🐛 49 | 🌐 Go | 📅 2026-08-20 - Caddy-based reverse proxy, configured with service or container labels.
...
* [Docker Volume Backup](https://github.com/offen/docker-volume-backup) ⭐ 3,996 | 🐛 27 | 🌐 Go | 📅 2026-09-01 Backup Docker volumes locally or to any S3 compatible storage.
...
* [cAdvisor](https://github.com/google/cadvisor) ⭐ 19,392 | 🐛 63 | 🌐 Go | 📅 2026-09-02 - Analyzes resource usage and performance characteristics of running containers.
...
* [Drydock](https://github.com/CodesWhat/drydock) ⭐ 250 | 🐛 10 | 🌐 TypeScript | 📅 2026-08-30 - Container update monitoring with web dashboard, 23 registry providers, 20 notification triggers, and distributed agent architecture.
...
* [DLIA](https://github.com/zorak1103/dlia) ⭐ 7 | 🐛 3 | 🌐 Go | 📅 2026-09-02 - DLIA is an AI-powered Docker log monitoring agent that uses Large Language Models (LLMs) to intelligently analyze container logs, detect anomalies, and provide contextual insights over time.
...
* [docker-exporter](https://github.com/dlepaux/docker-exporter) ⭐ 3 | 🐛 12 | 🌐 Rust | 📅 2026-09-02 - Lightweight Prometheus exporter for Docker container metrics written in Rust. Correct cgroup v2 memory working set on ARM64 (Raspberry Pi 5), runs non-root with a read-only socket, \~7 MiB idle RAM.
...
* [Sysdig Falco](https://github.com/falcosecurity/falco) ⭐ 9,324 | 🐛 64 | 🌐 C++ | 📅 2026-08-31 - Sysdig Falco is an open source container security monitor. It can monitor application, container, host, and network activity and alert on unauthorized activity.
* [Checkov](https://github.com/bridgecrewio/checkov) ⭐ 8,977 | 🐛 167 | 🌐 Python | 📅 2026-09-01 - Static analysis for infrastructure as code manifests (Terraform, Kubernetes, Cloudformation, Helm, Dockerfile, Kustomize) find security misconfiguration and fix them.
...
* [docker-socket-proxy](https://github.com/Tecnativa/docker-socket-proxy) ⭐ 2,743 | 🐛 52 | 🌐 Python | 📅 2026-08-31 - HAProxy-based fine-grained filter for the Docker API socket; widely used to expose a restricted socket to reverse proxies and homelab stacks.
...
* [compose-lint](https://github.com/tmatens/compose-lint) ⭐ 55 | 🐛 7 | 🌐 Python | 📅 2026-09-02 - Lints Docker Compose files for security misconfigurations — privileged containers, unpinned images, Docker socket mounts, plaintext credentials — grounded in OWASP and the CIS Docker Benchmark.
...
* [buildcage](https://github.com/dash14/buildcage) ⭐ 11 | 🐛 4 | 🌐 TypeScript | 📅 2026-09-02 - Restricts outbound network access during Docker builds to prevent supply chain attacks, working as a drop-in BuildKit remote driver for Docker Buildx, with ready-to-use GitHub Actions.
...
* [Stevedore](https://github.com/slonopotamus/stevedore) ⭐ 384 | 🐛 2 | 🌐 Rust | 📅 2026-08-30 - Good Docker Desktop replacement for Windows. Both Linux and Windows Containers are supported. [slonopotamus](https://github.com/slonopotamus).
...
* [lazydocker](https://github.com/jesseduffield/lazydocker) ⭐ 52,699 | 🐛 297 | 🌐 Go | 📅 2026-04-19 - The lazier way to manage everything docker. A simple terminal UI for both docker and docker-compose, written in Go with the gocui library.
...
* [lazyjournal](https://github.com/Lifailon/lazyjournal) ⭐ 1,394 | 🐛 8 | 🌐 Go | 📅 2026-08-01 - A interface for reading and filtering the logs output of Docker and Podman containers like [Dozzle](dozzle) but for the terminal with support for fuzzy find, regex and output coloring.
...
* [dockerfilegraph](https://github.com/patrickhoefler/dockerfilegraph) ⭐ 274 | 🐛 2 | 🌐 Go | 📅 2026-09-02 - Visualize your multi-stage Dockerfiles.
...
* [Portainer](https://github.com/portainer/portainer) ⭐ 38,412 | 🐛 745 | 🌐 TypeScript | 📅 2026-09-02 - A lightweight management UI for managing your Docker hosts or Docker Swarm clusters.
* [dockge](https://github.com/louislam/dockge) ⭐ 24,238 | 🐛 169 | 🌐 TypeScript | 📅 2026-04-25 - Easy-to-use and reactive self-hosted docker compose.yaml stack-oriented manager.
* [Komodo](https://github.com/mbecker20/komodo) ⭐ 12,142 | 🐛 616 | 🌐 Rust | 📅 2026-09-01 - A tool to build and deploy software on many servers.
* [Arcane](https://github.com/getarcaneapp/arcane) ⭐ 7,234 | 🐛 131 | 🌐 Go | 📅 2026-09-02 - An easy and modern Docker management platform, built with everybody in mind.
...
* [Docker Commander](https://github.com/koduj-dev/docker-commander) ⭐ 3 | 🐛 1 | 🌐 Go | 📅 2026-09-01 - A self-hosted Docker management and monitoring UI with multi-host support, Compose management, aggregated logs, alerts, RBAC, vulnerability scanning, and MCP integration.
...
* [dockerode](https://github.com/apocas/dockerode) ⭐ 4,945 | 🐛 25 | 🌐 JavaScript | 📅 2026-08-10 - Docker Remote API node.js module.
...
* [docker-controller-bot](https://github.com/dgongut/docker-controller-bot) ⭐ 257 | 🐛 14 | 🌐 Python | 📅 2026-09-01 - Telegram bot to control docker containers.
...
* [Drone](https://github.com/drone/drone) ⭐ 38,216 | 🐛 103 | 🌐 Go | 📅 2026-09-01 - Continuous integration server built on Docker and configured using YAML files.
* [Diun](https://github.com/crazy-max/diun) ⭐ 4,894 | 🐛 104 | 🌐 Go | 📅 2026-09-02 - Receive notifications when an image or repository is updated on a Docker registry.
* [dockcheck](https://github.com/mag37/dockcheck) ⭐ 2,498 | 🐛 8 | 🌐 Shell | 📅 2026-08-11 - A script checking updates for docker images without pulling then auto-update selected/all containers. With notifications, pruning and more.
...
* [Docker plugin for Jenkins](https://github.com/jenkinsci/docker-plugin/) ⭐ 499 | 🐛 99 | 🌐 Java | 📅 2026-09-01 - The aim of the docker plugin is to be able to use a docker host to dynamically provision a slave, run a single build, then tear-down that slave.
* [Defang](https://github.com/DefangLabs/defang) ⭐ 167 | 🐛 213 | 🌐 Go | 📅 2026-09-02 - Deploy Docker Compose to your favorite cloud in minutes.
...
* [coder](https://github.com/coder/coder) ⭐ 14,332 | 🐛 974 | 🌐 Go | 📅 2026-09-02 - Remote development machines powered by Terraform or Docker.
* [Laradock](https://github.com/laradock/laradock) ⭐ 12,673 | 🐛 17 | 🌐 Dockerfile | 📅 2026-09-02 - Full PHP development environment based on Docker, running Nginx/Apache, PHP, MySQL, Redis and more as swappable Compose services.
...
* [dde](https://github.com/whatwedo/dde) ⭐ 48 | 🐛 10 | 🌐 PHP | 📅 2026-09-01 - Local development environment toolset based on Docker.
...
* [Apache OpenWhisk](https://github.com/apache/openwhisk) ⭐ 6,793 | 🐛 430 | 🌐 Scala | 📅 2026-08-24 - A serverless, open source cloud platform that executes functions in response to events at any scale.
...
* [Pumba](https://github.com/alexei-led/pumba) ⭐ 3,140 | 🐛 4 | 🌐 Go | 📅 2026-09-02 - Chaos testing tool for Docker. Can be deployed on kubernetes and CoreOS cluster.
* [Container Structure Test](https://github.com/GoogleContainerTools/container-structure-test) ⭐ 2,494 | 🐛 116 | 🌐 Go | 📅 2026-07-20 - A framework to validate the structure of an image by checking the outputs of commands or the contents of the filesystem.
* [Kurtosis](https://github.com/kurtosis-tech/kurtosis) ⭐ 550 | 🐛 308 | 🌐 Go | 📅 2026-09-02 - A composable build system for multi-container test environments that provides developers with: a powerful Python-like SDK for environment configuration, a compile-time validator to verify environment behavior & setup, and a runtime for environment execution, monitoring, & debugging capabilities.
...
* [Ofelia](https://github.com/mcuadros/ofelia/) ⭐ 3,976 | 🐛 148 | 🌐 Go | 📅 2026-09-01 - Ofelia is a modern and low footprint job scheduler for docker environments, built on Go. Ofelia aims to be a replacement for the old fashioned cron. Supports configuration from container labels and/or configuration files.
* [supercronic](https://github.com/aptible/supercronic) ⭐ 2,623 | 🐛 54 | 🌐 Go | 📅 2026-08-14 - Crontab-compatible job runner, designed specifically to run in containers.
...
* [Dockerlings](https://github.com/furkan/dockerlings) ⭐ 1,030 | 🐛 0 | 🌐 Shell | 📅 2026-08-26: Learn docker from inside your terminal, with a modern TUI and bite sized exercises.
...
* [Cloud Native Landscape](https://github.com/cncf/landscape) ⭐ 9,985 | 🐛 102 | 📅 2026-09-02
...
* [Awesome Selfhosted](https://github.com/awesome-selfhosted/awesome-selfhosted) ⭐ 316,678 | 🐛 0 | 📅 2026-09-02 list of Free Software network services and web applications which can be hosted locally by running in a classical way (setup local web server and run applications from there) or in a Docker container.
* [Awesome Compose](https://github.com/docker/awesome-compose) ⭐ 46,213 | 🐛 418 | 🌐 HTML | 📅 2026-09-01 - Docker Compose samples.
* [Awesome Sysadmin](https://github.com/n1trux/awesome-sysadmin) ⭐ 35,047 | 🐛 0 | 📅 2026-09-02
...
* [Awesome Kubernetes](https://github.com/ramitsurana/awesome-kubernetes) ⭐ 16,065 | 🐛 85 | 🌐 Shell | 📅 2026-06-23
...
* [How CVE's are handled on Offical Docker Images](https://github.com/docker-library/official-images/issues/1448) ⭐ 6,994 | 🐛 44 | 🌐 Shell | 📅 2026-09-01
